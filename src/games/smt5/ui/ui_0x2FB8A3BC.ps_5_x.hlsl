// ---- Created with 3Dmigoto v1.3.16 on Sun Jul  7 23:08:55 2024
...
void main(
  ...
  r1.xyz = cb1[14].xyz * r0.xyz;
  r0.xyz = -r0.xyz * cb1[14].xyz + cb1[15].xyz;
  r2.w = saturate(cb1[16].y * r0.w);
  r0.xyz = cb1[16].xxx * r0.xyz + r1.xyz;
