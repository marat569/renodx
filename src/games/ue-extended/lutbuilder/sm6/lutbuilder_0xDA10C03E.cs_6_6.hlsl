// Remnant 2, fog area in N'Erud (UE 5.2.1)
...
void main(
  ...
  float4 output = ProcessLutbuilder(float3(_797, _799, _801), cb_config, RWOutputTexture[int3((uint)(SV_DispatchThreadID.x), (uint)(SV_DispatchThreadID.y), (uint)(SV_DispatchThreadID.z))], OutputDevice);
  ...
  if (OutputDevice == 0) {
    ...
    if (OutputDevice == 1) {
      ...
      if ((bool)(OutputDevice == 3) || (bool)(OutputDevice == 5)) {
        ...
        float _1471 = ((float((int)(((int)(uint)((bool)(_1456 > 0.0f))) - ((int)(uint)((bool)(_1456 < 0.0f))))) * (1.0f - (_1460 * _1460))) + 1.0f) * 0.02500000037252903f;
        do {
                      ...
                      do {
                        if (!(!(_1605 >= _1615))) {
                          ...
                          if (_1605 < (_1645 * 0.3010300099849701f)) {
                            ...
                            int _1654 = int(_1653);
                            float _1656 = _1653 - float((int)(_1654));
                  ...
                  do {
                    if (!(!(_1681 <= _1607))) {
                      ...
                      if ((bool)(_1681 > _1607) && (bool)(_1681 < _1689)) {
                        ...
                        int _1698 = int(_1697);
                        float _1700 = _1697 - float((int)(_1698));
                    ...
                    do {
                      if (!(!(_1755 <= _1607))) {
                        ...
                        if ((bool)(_1755 > _1607) && (bool)(_1755 < _1763)) {
                          ...
                          int _1772 = int(_1771);
                          float _1774 = _1771 - float((int)(_1772));
