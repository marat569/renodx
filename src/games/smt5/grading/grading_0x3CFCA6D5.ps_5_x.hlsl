...
// ---- Created with 3Dmigoto v1.3.16 on Mon Oct  7 22:38:18 2024
...
void main(
  ...
  float2 uv = r1.xz;
  float3 linear_color = renodx::draw::InvertIntermediatePass(r1.xzw);
  if (RENODX_TONE_MAP_TYPE != 0.f) {
    r1.xzw = GenerateSDRColor(linear_color);
  }
