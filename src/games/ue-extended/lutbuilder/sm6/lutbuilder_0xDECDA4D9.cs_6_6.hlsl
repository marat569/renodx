...
void main(
  ...
  float _414 = (1.0f - exp2(((_396 * _396) * -4.0f) * 0.f)) * (1.0f - exp2(dot(float3(_400, _401, _402), float3(_400, _401, _402)) * -4.0f));
  ...
  float4 output = ProcessLutbuilder(float3(_797, _799, _801), cb_config, RWOutputTexture[int3((uint)(SV_DispatchThreadID.x), (uint)(SV_DispatchThreadID.y), (uint)(SV_DispatchThreadID.z))], 0u);
  ...
  float _1171 = max(0.0f, mad((WorkingColorSpace.FromAP1[0].z), _1161, mad((WorkingColorSpace.FromAP1[0].y), _1160, ((WorkingColorSpace.FromAP1[0].x) * _1159))));
  float _1172 = max(0.0f, mad((WorkingColorSpace.FromAP1[1].z), _1161, mad((WorkingColorSpace.FromAP1[1].y), _1160, ((WorkingColorSpace.FromAP1[1].x) * _1159))));
  float _1173 = max(0.0f, mad((WorkingColorSpace.FromAP1[2].z), _1161, mad((WorkingColorSpace.FromAP1[2].y), _1160, ((WorkingColorSpace.FromAP1[2].x) * _1159))));
