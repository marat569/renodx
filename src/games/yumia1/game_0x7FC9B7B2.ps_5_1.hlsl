// ---- Created with 3Dmigoto v1.3.16 on Sun Mar 16 21:27:44 2025

// Main tonemap shader for ingame, starting area/cave
...
void main(
  ...
  o0 = ProcessColor(untonemapped, postGamma);
