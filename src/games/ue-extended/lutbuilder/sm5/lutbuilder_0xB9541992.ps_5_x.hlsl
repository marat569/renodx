// Found in Lost Soul Aside (UE 4.27)

#include "../lutbuilderoutput.hlsli"

// ---- Created with 3Dmigoto v1.3.16 on Thu Feb 12 02:59:25 2026
...
void main(
  ...
  cb_config.ue_tonecurveammount = asfloat(cb0[72].y);
  ...
  if (asuint(cb0[44].y) != 0) {
    ...
    r0.xyz = cb0[71].www * r3.xyz + r0.xyz;
    ...
    r3.xyz = max(float3(0, 0, 0), r3.xyz);
    r3.xyz = r3.xyz + -r0.xyz;
    r0.xyz = cb0[72].yyy * r3.xyz + r0.xyz;
  ...
  if (asuint(cb0[71].x) == 0) {
    ...
    r5.xyzw = cmp(asint(cb0[71].yyyy) == int4(1, 2, 3, 4));
    r6.xyz = r5.www ? float3(1, 0, 0) : float3(1.70505154, -0.621790707, -0.0832583979);
    r7.xyz = r5.www ? float3(0, 1, 0) : float3(-0.130257145, 1.14080286, -0.0105485283);
    r8.xyz = r5.www ? float3(0, 0, 1) : float3(-0.0240032747, -0.128968775, 1.15297174);
    r6.xyz = r5.zzz ? float3(0.695452213, 0.140678704, 0.163869068) : r6.xyz;
    r7.xyz = r5.zzz ? float3(0.0447945632, 0.859671116, 0.0955343172) : r7.xyz;
    r8.xyz = r5.zzz ? float3(-0.00552588282, 0.00402521016, 1.00150073) : r8.xyz;
    r6.xyz = r5.yyy ? float3(1.02579927, -0.0200525094, -0.00577136781) : r6.xyz;
    r7.xyz = r5.yyy ? float3(-0.00223502493, 1.00458264, -0.00235231337) : r7.xyz;
    r5.yzw = r5.yyy ? float3(-0.00501400325, -0.0252933875, 1.03044021) : r8.xyz;
    r6.xyz = r5.xxx ? float3(1.37915885, -0.308850735, -0.0703467429) : r6.xyz;
    r7.xyz = r5.xxx ? float3(-0.0693352968, 1.08229232, -0.0129620517) : r7.xyz;
    r5.xyz = r5.xxx ? float3(-0.00215925858, -0.0454653986, 1.04775953) : r5.yzw;
    r0.w = cmp(asint(cb0[71].x) == 1);
    if (r0.w != 0) {
      ...
      r4.xyz = min(r9.xyz, r8.xyz);
    } else {
      r8.xyz = cb0[42].yzw * r1.xyz;
      r1.xyz = -r1.xyz * cb0[42].yzw + cb0[43].xyz;
      r4.xyz = cb0[43].www * r1.xyz + r8.xyz;
      r1.xy = cmp(asint(cb0[71].xx) == int2(3, 5));
      r0.w = (int)r1.y | (int)r1.x;
      if (r0.w != 0) {
        r1.xyz = float3(1.5, 1.5, 1.5) * r4.xyz;
        r8.y = dot(float3(0.439700812, 0.382978052, 0.1773348), r1.xyz);
        r8.z = dot(float3(0.0897923037, 0.813423157, 0.096761629), r1.xyz);
        r8.w = dot(float3(0.0175439864, 0.111544058, 0.870704114), r1.xyz);
        r0.w = min(r8.y, r8.z);
        r0.w = min(r0.w, r8.w);
        r1.x = max(r8.y, r8.z);
        r1.x = max(r1.x, r8.w);
        ...
        r1.x = r1.w ? r1.z : r1.x;
        r1.x = 1 + r1.x;
        r9.yzw = r8.yzw * r1.xxx;
        r1.yz = cmp(r9.zw == r9.yz);
        r1.y = r1.z ? r1.y : 0;
        r1.z = r8.z * r1.x + -r9.w;
        ...
        if (r1.z != 0) {
          ...
          r1.z = r1.y * r1.y;
          r2.w = r1.z * r1.y;
          r8.xzw = float3(-0.166666672, -0.5, 0.166666672) * r2.www;
          r8.xz = r1.zz * float2(0.5, 0.5) + r8.xz;
          r8.xz = r1.yy * float2(-0.5, 0.5) + r8.xz;
          r1.y = r2.w * 0.5 + -r1.z;
          r1.y = 0.666666687 + r1.y;
          r10.xyz = cmp((int3)r1.www == int3(3, 2, 1));
          r8.xz = float2(0.166666672, 0.166666672) + r8.xz;
          r1.z = r1.w ? 0 : r8.w;
          r1.z = r10.z ? r8.z : r1.z;
          r1.y = r10.y ? r1.y : r1.z;
          r1.y = r10.x ? r8.x : r1.y;
        } else {
          r1.y = 0;
        }
        r0.w = r1.y * r0.w;
        r0.w = 1.5 * r0.w;
        r1.x = -r8.y * r1.x + 0.0299999993;
        r0.w = r1.x * r0.w;
        r9.x = r0.w * 0.180000007 + r9.y;
        r1.xyz = max(float3(0, 0, 0), r9.xzw);
        r1.xyz = min(float3(65535, 65535, 65535), r1.xyz);
        r8.x = dot(float3(1.45143926, -0.236510754, -0.214928567), r1.xyz);
        r8.y = dot(float3(-0.0765537769, 1.17622972, -0.0996759236), r1.xyz);
        r8.z = dot(float3(0.00831614807, -0.00603244966, 0.997716308), r1.xyz);
        r1.xyz = max(float3(0, 0, 0), r8.xyz);
        r1.xyz = min(float3(65535, 65535, 65535), r1.xyz);
        ...
        r1.xyz = log2(r1.xyz);
        r1.xyz = r8.xyz ? float3(-14, -14, -14) : r1.xyz;
        r8.xyz = cmp(float3(-17.4739323, -17.4739323, -17.4739323) >= r1.xyz);
        if (r8.x != 0) {
          r0.w = -4;
        } else {
        ...
        if (r8.z != 0) {
          ...
          if (r1.x != 0) {
            ...
            if (r1.x != 0) {
              ...
              r10.y = icb[r1.x + 0].y;
              r10.z = icb[r1.y + 0].y;
              r1.x = dot(r10.xzy, float3(0.5, 0.5, -1));
              r1.y = dot(r10.xy, float2(-1, 1));
              r1.z = dot(r10.xy, float2(0.5, 0.5));
              r8.z = 1;
        ...
        r0.w = 3.32192802 * r0.w;
        r9.z = exp2(r0.w);
        r1.x = dot(float3(0.695452213, 0.140678704, 0.163869068), r9.xyz);
        r1.y = dot(float3(0.0447945632, 0.859671116, 0.0955343172), r9.xyz);
        r1.z = dot(float3(-0.00552588282, 0.00402521016, 1.00150073), r9.xyz);
        ...
        r8.z = exp2(r0.w);
        r1.xyz = float3(-3.50738446e-05, -3.50738446e-05, -3.50738446e-05) + r8.xyz;
        r8.x = dot(r6.xyz, r1.xyz);
        r8.y = dot(r7.xyz, r1.xyz);
        r8.z = dot(r5.xyz, r1.xyz);
        r1.xyz = float3(9.99999975e-05, 9.99999975e-05, 9.99999975e-05) * r8.xyz;
        r1.xyz = log2(r1.xyz);
        r1.xyz = float3(0.159301758, 0.159301758, 0.159301758) * r1.xyz;
        r1.xyz = exp2(r1.xyz);
        r8.xyz = r1.xyz * float3(18.8515625, 18.8515625, 18.8515625) + float3(0.8359375, 0.8359375, 0.8359375);
        ...
        r1.xy = cmp(asint(cb0[71].xx) == int2(4, 6));
        r0.w = (int)r1.y | (int)r1.x;
        if (r0.w != 0) {
          r1.xyz = float3(1.5, 1.5, 1.5) * r4.xyz;
          r8.y = dot(float3(0.439700812, 0.382978052, 0.1773348), r1.xyz);
          ...
          r0.w = cmp(asint(cb0[71].x) == 7);
          if (r0.w != 0) {
            r1.x = dot(float3(0.613191485, 0.33951208, 0.0473663323), r4.xyz);
            r1.y = dot(float3(0.0702069029, 0.916335821, 0.0134500116), r4.xyz);
            r1.z = dot(float3(0.0206188709, 0.109567292, 0.869606733), r4.xyz);
            r8.x = dot(r6.xyz, r1.xyz);
            r8.y = dot(r7.xyz, r1.xyz);
            r8.z = dot(r5.xyz, r1.xyz);
            r1.xyz = float3(9.99999975e-05, 9.99999975e-05, 9.99999975e-05) * r8.xyz;
            ...
            r0.w = cmp(asint(cb0[71].x) == 8);
            if (r0.w == 0) {
              r0.w = cmp(asint(cb0[71].x) == 9);
              if (r0.w != 0) {
                ...
                r4.z = dot(r5.xyz, r1.xyz);
              } else {
                r0.xy = cmp(asint(cb0[71].xx) == int2(10, 11));
                r0.x = (int)r0.y | (int)r0.x;
                if (r0.x != 0) {
                  r0.xyz = float3(12.9200001, 12.9200001, 12.9200001) * r3.xyz;
                  r1.xyz = cmp(r3.xyz >= float3(0.00313066994, 0.00313066994, 0.00313066994));
                  ...
                  r1.y = dot(float3(0.0702069029, 0.916335821, 0.0134500116), r0.xyz);
                  r1.z = dot(float3(0.0206188709, 0.109567292, 0.869606733), r0.xyz);
                  r0.xyz = cb0[71].zzz * r1.xyz;
                  r0.w = cmp(asint(cb0[71].x) != 11);
                  ...
                  r0.xy = cmp(asint(cb0[71].xx) == int2(12, 13));
                  r0.x = (int)r0.y | (int)r0.x;
                  if (r0.x != 0) {
                    r0.xyz = cb0[70].zzz * r4.xyz;
                    ...
                    r0.x = dot(float3(1.45143926, -0.236510754, -0.214928567), r1.yzw);
                    r0.y = dot(float3(-0.0765537769, 1.17622972, -0.0996759236), r1.yzw);
                    r0.z = dot(float3(0.00831614807, -0.00603244966, 0.997716308), r1.yzw);
                    r0.w = max(r0.y, r0.z);
                    r0.w = max(r0.x, r0.w);
                    r1.x = cmp(r0.w < 1.00000001e-10);
                    r2.xyz = cmp(r1.yzw < float3(0, 0, 0));
                    ...
                    if (r1.x == 0) {
                      ...
                      r8.xyz = cmp(r2.xyz < float3(0.814999998, 0.802999973, 0.879999995));
                      r9.xyz = float3(-0.814999998, -0.802999973, -0.879999995) + r2.xyz;
                      r10.xyzw = float4(3.05528307, 1, 3.49726105, 1) * r9.xxyy;
                      r9.xy = log2(r10.xz);
                      r9.xy = float2(1.20000005, 1.20000005) * r9.xy;
                      r9.xy = exp2(r9.xy);
                      r9.xy = float2(1, 1) + r9.xy;
                      r9.xy = log2(r9.xy);
                      r9.xy = float2(0.833333313, 0.833333313) * r9.xy;
                      r9.xy = exp2(r9.xy);
                      r9.xy = r10.yw / r9.xy;
                      r9.xy = float2(0.814999998, 0.802999973) + r9.xy;
                      r2.xy = r8.xy ? r2.xy : r9.xy;
                      r8.xy = float2(6.81099463, 1) * r9.zz;
                      r1.x = log2(r8.x);
                      r1.x = 1.20000005 * r1.x;
                      r1.x = exp2(r1.x);
                      r1.x = 1 + r1.x;
                      r1.x = log2(r1.x);
                      r1.x = 0.833333313 * r1.x;
                      r1.x = exp2(r1.x);
                      r1.x = r8.y / r1.x;
                      r1.x = 0.879999995 + r1.x;
                      r1.x = r8.z ? r2.z : r1.x;
                      r0.xy = -r2.xy * abs(r0.ww) + r0.ww;
                      r0.z = -r1.x * abs(r0.w) + r0.w;
                    }
                    r2.y = dot(float3(0.695452213, 0.140678704, 0.163869068), r0.xyz);
                    r2.z = dot(float3(0.0447945632, 0.859671116, 0.0955343172), r0.xyz);
                    r2.w = dot(float3(-0.00552588282, 0.00402521016, 1.00150073), r0.xyz);
                    r0.xyz = r2.yzw + -r1.yzw;
                    r0.xyz = cb0[70].www * r0.xyz + r1.yzw;
                    r0.w = min(r0.x, r0.y);
                    r0.w = min(r0.w, r0.z);
                    r1.x = max(r0.x, r0.y);
                    r1.x = max(r1.x, r0.z);
                    ...
                    r1.z = r1.z * r1.w;
                    r1.w = r1.z * r1.z;
                    r3.w = r1.w * 0.0208350997 + -0.0851330012;
                    r3.w = r1.w * r3.w + 0.180141002;
                    r3.w = r1.w * r3.w + -0.330299497;
                    r1.w = r1.w * r3.w + 0.999866009;
                    r3.w = r1.z * r1.w;
                    r4.w = cmp(abs(r0.z) < abs(r0.y));
                    ...
                    if (r0.z != 0) {
                      ...
                      r8.xy = r0.yy * float2(-0.5, 0.5) + r8.xy;
                      r0.y = r1.z * 0.5 + -r0.z;
                      r0.y = 0.666666687 + r0.y;
                      r9.xyz = cmp((int3)r1.yyy == int3(3, 2, 1));
                    ...
                    if (r2.x != 0) {
                      ...
                      r2.x = r2.x ? r4.w : 0;
                      if (r2.x != 0) {
                        r2.x = r0.x * 0.30103001 + -r0.w;
                        r2.x = 3 * r2.x;
                        r2.w = r2.w * 0.30103001 + -r0.w;
                        r2.x = r2.x / r2.w;
                        r2.w = (int)r2.x;
                        r4.w = trunc(r2.x);
                        r8.y = -r4.w + r2.x;
                        r9.xyzw = cmp((int4)r2.wwww == int4(3, 2, 1, 0));
                        r10.xy = cmp((int2)r2.ww == int2(4, 5));
                        r9.xyzw = r9.xyzw ? float4(1, 1, 1, 1) : 0;
                        r10.xy = r10.xy ? float2(1, 1) : 0;
                        r2.x = dot(r9.wzyx, cb0[68].xyzw);
                        r2.x = r10.x * cb0[70].x + r2.x;
                        r9.x = r10.y * cb0[70].x + r2.x;
                        r10.xyzw = (int4)r2.wwww + int4(1, 1, 2, 2);
                        ...
                        r2.x = dot(r11.wzyx, cb0[68].xyzw);
                        r2.x = r12.x * cb0[70].x + r2.x;
                        r9.y = r12.y * cb0[70].x + r2.x;
                        r10.xyzw = cmp((int4)r10.wwww == int4(3, 2, 1, 0));
                        r10.xyzw = r10.xyzw ? float4(1, 1, 1, 1) : 0;
                        r2.x = dot(r10.wzyx, cb0[68].xyzw);
                        r2.x = r12.z * cb0[70].x + r2.x;
                        r9.z = r12.w * cb0[70].x + r2.x;
                        r8.x = r8.y * r8.y;
                        ...
                        r2.x = cmp(r1.x >= r3.w);
                        r2.w = log2(cb0[66].z);
                        r4.w = 0.30103001 * r2.w;
                        r1.x = cmp(r1.x < r4.w);
                        r1.x = r1.x ? r2.x : 0;
                        if (r1.x != 0) {
                          r0.x = r0.x * 0.30103001 + -r3.w;
                          r0.x = 3 * r0.x;
                          r1.x = r2.w * 0.30103001 + -r3.w;
                          r0.x = r0.x / r1.x;
                          r1.x = (int)r0.x;
                          r2.x = trunc(r0.x);
                          r8.y = -r2.x + r0.x;
                          r9.xyzw = cmp((int4)r1.xxxx == int4(3, 2, 1, 0));
                          r2.xw = cmp((int2)r1.xx == int2(4, 5));
                          r9.xyzw = r9.xyzw ? float4(1, 1, 1, 1) : 0;
                          r2.xw = r2.xw ? float2(1, 1) : 0;
                          r0.x = dot(r9.wzyx, cb0[69].xyzw);
                          r0.x = r2.x * cb0[70].y + r0.x;
                          r9.x = r2.w * cb0[70].y + r0.x;
                          r10.xyzw = (int4)r1.xxxx + int4(1, 1, 2, 2);
                          r11.xyzw = cmp((int4)r10.yyyy == int4(3, 2, 1, 0));
                          r12.xyzw = cmp((int4)r10.xyzw == int4(4, 5, 4, 5));
                          r11.xyzw = r11.xyzw ? float4(1, 1, 1, 1) : 0;
                          r12.xyzw = r12.xyzw ? float4(1, 1, 1, 1) : 0;
                          r0.x = dot(r11.wzyx, cb0[69].xyzw);
                          r0.x = r12.x * cb0[70].y + r0.x;
                          r9.y = r12.y * cb0[70].y + r0.x;
                          r10.xyzw = cmp((int4)r10.wwww == int4(3, 2, 1, 0));
                          r10.xyzw = r10.xyzw ? float4(1, 1, 1, 1) : 0;
                          r0.x = dot(r10.wzyx, cb0[69].xyzw);
                          r0.x = r12.z * cb0[70].y + r0.x;
                          r9.z = r12.w * cb0[70].y + r0.x;
                          r8.x = r8.y * r8.y;
                          r10.x = dot(r9.xzy, float3(0.5, 0.5, -1));
                          r10.y = dot(r9.xy, float2(-1, 1));
                          r10.z = dot(r9.xy, float2(0.5, 0.5));
                    ...
                    if (r2.y != 0) {
                      ...
                      r1.w = r1.w ? r2.w : 0;
                      if (r1.w != 0) {
                        r1.w = r0.y * 0.30103001 + -r0.w;
                        r1.w = 3 * r1.w;
                        r2.x = r2.x * 0.30103001 + -r0.w;
                        r1.w = r1.w / r2.x;
                        r2.x = (int)r1.w;
                        r2.w = trunc(r1.w);
                        r8.y = -r2.w + r1.w;
                        r9.xyzw = cmp((int4)r2.xxxx == int4(3, 2, 1, 0));
                        r10.xy = cmp((int2)r2.xx == int2(4, 5));
                        r9.xyzw = r9.xyzw ? float4(1, 1, 1, 1) : 0;
                        r10.xy = r10.xy ? float2(1, 1) : 0;
                        r1.w = dot(r9.wzyx, cb0[68].xyzw);
                        r1.w = r10.x * cb0[70].x + r1.w;
                        r9.x = r10.y * cb0[70].x + r1.w;
                        r10.xyzw = (int4)r2.xxxx + int4(1, 1, 2, 2);
                        r11.xyzw = cmp((int4)r10.yyyy == int4(3, 2, 1, 0));
                        r12.xyzw = cmp((int4)r10.xyzw == int4(4, 5, 4, 5));
                        r11.xyzw = r11.xyzw ? float4(1, 1, 1, 1) : 0;
                        r12.xyzw = r12.xyzw ? float4(1, 1, 1, 1) : 0;
                        r1.w = dot(r11.wzyx, cb0[68].xyzw);
                        r1.w = r12.x * cb0[70].x + r1.w;
                        r9.y = r12.y * cb0[70].x + r1.w;
                        r10.xyzw = cmp((int4)r10.wwww == int4(3, 2, 1, 0));
                        r10.xyzw = r10.xyzw ? float4(1, 1, 1, 1) : 0;
                        r1.w = dot(r10.wzyx, cb0[68].xyzw);
                        r1.w = r12.z * cb0[70].x + r1.w;
                        r9.z = r12.w * cb0[70].x + r1.w;
                        r8.x = r8.y * r8.y;
                        r10.x = dot(r9.xzy, float3(0.5, 0.5, -1));
                        r10.y = dot(r9.xy, float2(-1, 1));
                        r10.z = dot(r9.xy, float2(0.5, 0.5));
                        ...
                        r1.w = cmp(r1.y >= r2.y);
                        r2.x = log2(cb0[66].z);
                        r2.w = 0.30103001 * r2.x;
                        r1.y = cmp(r1.y < r2.w);
                        r1.y = r1.y ? r1.w : 0;
                        if (r1.y != 0) {
                          r0.y = r0.y * 0.30103001 + -r2.y;
                          r0.y = 3 * r0.y;
                          r1.y = r2.x * 0.30103001 + -r2.y;
                          r0.y = r0.y / r1.y;
                          r1.y = (int)r0.y;
                          r1.w = trunc(r0.y);
                          r8.y = -r1.w + r0.y;
                          r9.xyzw = cmp((int4)r1.yyyy == int4(3, 2, 1, 0));
                          r2.xy = cmp((int2)r1.yy == int2(4, 5));
                          r9.xyzw = r9.xyzw ? float4(1, 1, 1, 1) : 0;
                          r2.xy = r2.xy ? float2(1, 1) : 0;
                          r0.y = dot(r9.wzyx, cb0[69].xyzw);
                          r0.y = r2.x * cb0[70].y + r0.y;
                          r9.x = r2.y * cb0[70].y + r0.y;
                          r10.xyzw = (int4)r1.yyyy + int4(1, 1, 2, 2);
                          r11.xyzw = cmp((int4)r10.yyyy == int4(3, 2, 1, 0));
                          r12.xyzw = cmp((int4)r10.xyzw == int4(4, 5, 4, 5));
                          r11.xyzw = r11.xyzw ? float4(1, 1, 1, 1) : 0;
                          r12.xyzw = r12.xyzw ? float4(1, 1, 1, 1) : 0;
                          r0.y = dot(r11.wzyx, cb0[69].xyzw);
                          r0.y = r12.x * cb0[70].y + r0.y;
                          r9.y = r12.y * cb0[70].y + r0.y;
                          r10.xyzw = cmp((int4)r10.wwww == int4(3, 2, 1, 0));
                          r10.xyzw = r10.xyzw ? float4(1, 1, 1, 1) : 0;
                          r0.y = dot(r10.wzyx, cb0[69].xyzw);
                          r0.y = r12.z * cb0[70].y + r0.y;
                          r9.z = r12.w * cb0[70].y + r0.y;
                          r8.x = r8.y * r8.y;
                          r10.x = dot(r9.xzy, float3(0.5, 0.5, -1));
                          r10.y = dot(r9.xy, float2(-1, 1));
                          r10.z = dot(r9.xy, float2(0.5, 0.5));
                          ...
                          r0.y = log2(cb0[66].w);
                          r1.x = 0.30103001 * r0.y;
                        }
                      }
                    }
                    r0.y = 3.32192802 * r1.x;
                    r0.y = exp2(r0.y);
                    if (r2.z != 0) {
                      r1.x = log2(cb0[66].y);
                      r1.x = 0.30103001 * r1.x;
                      ...
                      r1.y = r1.y ? r2.y : 0;
                      if (r1.y != 0) {
                        r1.y = r0.z * 0.30103001 + -r0.w;
                        r1.y = 3 * r1.y;
                        r0.w = r1.w * 0.30103001 + -r0.w;
                        r0.w = r1.y / r0.w;
                        r1.y = (int)r0.w;
                        r1.w = trunc(r0.w);
                        r8.y = -r1.w + r0.w;
                        r9.xyzw = cmp((int4)r1.yyyy == int4(3, 2, 1, 0));
                        r2.yz = cmp((int2)r1.yy == int2(4, 5));
                        r9.xyzw = r9.xyzw ? float4(1, 1, 1, 1) : 0;
                        r2.yz = r2.yz ? float2(1, 1) : 0;
                        r0.w = dot(r9.wzyx, cb0[68].xyzw);
                        r0.w = r2.y * cb0[70].x + r0.w;
                        r9.x = r2.z * cb0[70].x + r0.w;
                        r10.xyzw = (int4)r1.yyyy + int4(1, 1, 2, 2);
                        r11.xyzw = cmp((int4)r10.yyyy == int4(3, 2, 1, 0));
                        r12.xyzw = cmp((int4)r10.xyzw == int4(4, 5, 4, 5));
                        r11.xyzw = r11.xyzw ? float4(1, 1, 1, 1) : 0;
                        r12.xyzw = r12.xyzw ? float4(1, 1, 1, 1) : 0;
                        r0.w = dot(r11.wzyx, cb0[68].xyzw);
                        r0.w = r12.x * cb0[70].x + r0.w;
                        r9.y = r12.y * cb0[70].x + r0.w;
                        r10.xyzw = cmp((int4)r10.wwww == int4(3, 2, 1, 0));
                        r10.xyzw = r10.xyzw ? float4(1, 1, 1, 1) : 0;
                        r0.w = dot(r10.wzyx, cb0[68].xyzw);
                        r0.w = r12.z * cb0[70].x + r0.w;
                        r9.z = r12.w * cb0[70].x + r0.w;
                        r8.x = r8.y * r8.y;
                        r10.x = dot(r9.xzy, float3(0.5, 0.5, -1));
                        r10.y = dot(r9.xy, float2(-1, 1));
                        r10.z = dot(r9.xy, float2(0.5, 0.5));
                        ...
                        r0.w = r0.w ? r1.z : 0;
                        if (r0.w != 0) {
                          r0.z = r0.z * 0.30103001 + -r2.x;
                          r0.z = 3 * r0.z;
                          r0.w = r1.y * 0.30103001 + -r2.x;
                          r0.z = r0.z / r0.w;
                          r0.w = (int)r0.z;
                          r1.y = trunc(r0.z);
                          r2.y = -r1.y + r0.z;
                          r8.xyzw = cmp((int4)r0.wwww == int4(3, 2, 1, 0));
                          r1.yz = cmp((int2)r0.ww == int2(4, 5));
                          r8.xyzw = r8.xyzw ? float4(1, 1, 1, 1) : 0;
                          r1.yz = r1.yz ? float2(1, 1) : 0;
                          r0.z = dot(r8.wzyx, cb0[69].xyzw);
                          r0.z = r1.y * cb0[70].y + r0.z;
                          r8.x = r1.z * cb0[70].y + r0.z;
                          r9.xyzw = (int4)r0.wwww + int4(1, 1, 2, 2);
                          r10.xyzw = cmp((int4)r9.yyyy == int4(3, 2, 1, 0));
                          r11.xyzw = cmp((int4)r9.xyzw == int4(4, 5, 4, 5));
                          r10.xyzw = r10.xyzw ? float4(1, 1, 1, 1) : 0;
                          r11.xyzw = r11.xyzw ? float4(1, 1, 1, 1) : 0;
                          r0.z = dot(r10.wzyx, cb0[69].xyzw);
                          r0.z = r11.x * cb0[70].y + r0.z;
                          r8.y = r11.y * cb0[70].y + r0.z;
                          r9.xyzw = cmp((int4)r9.wwww == int4(3, 2, 1, 0));
                          r9.xyzw = r9.xyzw ? float4(1, 1, 1, 1) : 0;
                          r0.z = dot(r9.wzyx, cb0[69].xyzw);
                          r0.z = r11.z * cb0[70].y + r0.z;
                          r8.z = r11.w * cb0[70].y + r0.z;
                          r2.x = r2.y * r2.y;
                          ...
                          r0.z = log2(cb0[66].w);
                          r1.x = 0.30103001 * r0.z;
                        }
                      }
                    }
                    r0.z = 3.32192802 * r1.x;
                    r0.z = exp2(r0.z);
                    r0.x = -cb0[66].y + r0.x;
                    r0.w = cb0[66].w + -cb0[66].y;
                    r1.x = r0.x / r0.w;
                    r0.x = -cb0[66].y + r0.y;
                    r1.y = r0.x / r0.w;
                    r0.x = -cb0[66].y + r0.z;
                    ...
                    r1.x = saturate(dot(float3(1.6410234, -0.324803293, -0.236424699), r0.xyz));
                    r1.y = saturate(dot(float3(-0.663662851, 1.61533165, 0.0167563483), r0.xyz));
                    r1.z = saturate(dot(float3(0.0117218941, -0.00828444213, 0.988394856), r0.xyz));
                    r0.x = dot(float3(0.662454188, 0.134004205, 0.156187683), r1.xyz);
                    r0.y = dot(float3(0.272228718, 0.674081743, 0.0536895171), r1.xyz);
                    r0.z = dot(float3(-0.00557464967, 0.0040607336, 1.01033914), r1.xyz);
                    ...
                    r0.xyz = max(float3(0, 0, 0), r1.xyz);
                    r0.xyz = cb0[66].www * r0.xyz;
                    r0.xyz = max(float3(0, 0, 0), r0.xyz);
                    r0.xyz = min(float3(65535, 65535, 65535), r0.xyz);
                    r0.w = cmp(asint(cb0[71].x) != 13);
                    r1.x = dot(r6.xyz, r0.xyz);
                    r1.y = dot(r7.xyz, r0.xyz);
                    r1.z = dot(r5.xyz, r0.xyz);
                    r0.xyz = r0.www ? r1.xyz : r0.xyz;
  ...
  o0.xyz = float3(0.952381015, 0.952381015, 0.952381015) * r4.xyz;
  o0.w = 0;
  return;
}
