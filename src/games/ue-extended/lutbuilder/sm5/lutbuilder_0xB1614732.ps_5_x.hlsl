...
// ---- Created with 3Dmigoto v1.4.1 on Thu Dec 26 02:02:35 2024
...
void main(
  ...
  r0.x = cb0[35].y * cb0[35].y;
  r0.y = cb0[35].y * 1189.62 + r0.x;
  r0.y = 1412139.88 + r0.y;
  r0.y = r0.y * r0.y;
  r1.xyz = -cb0[35].yyy * float3(2.8974182e-05, 1916156.25, 705674) + float3(1, -1.13758118e+09, 1.97471539e+09);
  r0.zw = -r0.xx * float2(1.53176999, 308.606995) + r1.yz;
  r1.x = r0.x * 1.61456057e-07 + r1.x;
  r2.x = r0.z / r0.y;
  r0.y = -cb0[35].y * 179.455994 + r0.x;
  r0.y = 6193636 + r0.y;
  r0.y = r0.y * r0.y;
  r2.y = r0.w / r0.y;
  ...
  r0.y = cb0[35].z * -r0.y;
  r0.z = cb0[35].z * r0.z;
  r1.yzw = cb0[35].yyy * float3(0.000154118257, 0.00084242021, 4.22806261e-05) + float3(0.860117733, 1, 0.317398727);
  r1.yzw = r0.xxx * float3(1.28641219e-07, 7.08145137e-07, 4.20481676e-08) + r1.yzw;
  r0.xw = r1.wy / r1.xz;
  r0.y = r0.y * 0.0500000007 + r0.x;
  ...
  r1.xy = r0.yx / r0.zz;
  r0.xy = r2.xy + -r1.xy;
  r0.z = cb0[35].y * 1.00055635;
  r0.z = 1 / r0.z;
  r1.zw = -r0.zz * float2(4.60700006e+09, 2.0064e+09) + float2(2967800, 1901800);
  r1.zw = r1.zw * r0.zz + float2(99.1100006, 247.479996);
  r0.zw = r1.zw * r0.zz + float2(0.244063005, 0.237039998);
  r1.z = cmp(6996.10791 >= cb0[35].y);
  r2.x = r1.z ? r0.z : r0.w;
  r0.z = r2.x * r2.x;
  r0.w = 2.86999989 * r2.x;
  r0.z = r0.z * -3 + r0.w;
  r2.y = -0.275000006 + r0.z;
  r0.z = cmp(cb0[35].y < 4000);
  ...
  r2.w = r0.x;
  r2.z = 1;
  r0.x = dot(float3(0.895099998, 0.266400009, -0.161400005), r2.xzw);
  r0.zw = r2.yz;
  r1.x = dot(float3(-0.161400005, 0.895099998, 0.266400009), r0.yzw);
  r0.x = r1.x / r0.x;
  r1.xyz = float3(0.895099998, 0.266400009, -0.161400005) * r0.xxx;
  r3.x = r1.z;
  r0.x = dot(float3(-0.750199974, 1.71350002, 0.0366999991), r2.xzw);
  r1.w = dot(float3(0.0388999991, -0.0684999973, 1.02960002), r2.xzw);
  r2.x = dot(float3(0.0366999991, -0.750199974, 1.71350002), r0.yzw);
  r0.y = dot(float3(1.02960002, 0.0388999991, -0.0684999973), r0.yzw);
  r0.y = r0.y / r1.w;
  r0.yzw = float3(0.0388999991, -0.0684999973, 1.02960002) * r0.yyy;
  r0.x = r2.x / r0.x;
  r2.xyz = float3(-0.750199974, 1.71350002, 0.0366999991) * r0.xxx;
  r3.y = r2.z;
  r3.z = r0.w;
  r0.x = dot(float3(0.432305306, 0.518360317, 0.0492912009), r3.xyz);
  r4.x = r1.y;
  r4.y = r2.y;
  r1.y = r2.x;
  r4.z = r0.z;
  r1.z = r0.y;
  r0.y = dot(float3(0.432305306, 0.518360317, 0.0492912009), r4.xyz);
  r0.yzw = cb1[1].xyz * r0.yyy;
  r1.w = dot(float3(0.432305306, 0.518360317, 0.0492912009), r1.xyz);
  r0.yzw = r1.www * cb1[0].xyz + r0.yzw;
  r0.xyz = r0.xxx * cb1[2].xyz + r0.yzw;
  r2.xyz = cb1[4].yyy * r0.xyz;
  r0.w = dot(float3(0.986992896, -0.1470543, 0.159962699), r4.xyz);
  r1.w = dot(float3(-0.0085287001, 0.040042799, 0.968486726), r4.xyz);
  r4.xyz = cb1[1].xyz * r1.www;
  r5.xyz = cb1[1].xyz * r0.www;
  r0.w = dot(float3(0.986992896, -0.1470543, 0.159962699), r1.xyz);
  r1.x = dot(float3(-0.0085287001, 0.040042799, 0.968486726), r1.xyz);
  r1.xyz = r1.xxx * cb1[0].xyz + r4.xyz;
  r4.xyz = r0.www * cb1[0].xyz + r5.xyz;
  r0.w = dot(float3(0.986992896, -0.1470543, 0.159962699), r3.xyz);
  r1.w = dot(float3(-0.0085287001, 0.040042799, 0.968486726), r3.xyz);
  r1.xyz = r1.www * cb1[2].xyz + r1.xyz;
  r3.xyz = r0.www * cb1[2].xyz + r4.xyz;
  r2.xyz = cb1[4].xxx * r3.xyz + r2.xyz;
  r2.xyz = cb1[4].zzz * r1.xyz + r2.xyz;
  r0.w = 0.5 / cb0[35].x;
  r4.xy = v0.xy + -r0.ww;
  r4.xy = cb0[35].xx * r4.xy;
  r0.w = cb0[35].x + -1;
  r4.xy = r4.xy / r0.ww;
  r1.w = (uint)v2.x;
  r4.z = r1.w / r0.w;
  r4.xyz = float3(-0.434017599, -0.434017599, -0.434017599) + r4.xyz;
  r4.xyz = float3(14, 14, 14) * r4.xyz;
  r4.xyz = exp2(r4.xyz);
  r4.xyz = r4.xyz * float3(0.180000007, 0.180000007, 0.180000007) + float3(-0.00266771927, -0.00266771927, -0.00266771927);
  r2.x = dot(r2.xyz, r4.xyz);
  r5.xyz = cb1[5].yyy * r0.xyz;
  r0.xyz = cb1[6].yyy * r0.xyz;
  r0.xyz = cb1[6].xxx * r3.xyz + r0.xyz;
  r3.xyz = cb1[5].xxx * r3.xyz + r5.xyz;
  r3.xyz = cb1[5].zzz * r1.xyz + r3.xyz;
  r0.xyz = cb1[6].zzz * r1.xyz + r0.xyz;
  r2.z = dot(r0.xyz, r4.xyz);
  r2.y = dot(r3.xyz, r4.xyz);
  r0.x = dot(cb1[8].xyz, r2.xyz);
  r0.y = dot(cb1[9].xyz, r2.xyz);
  r0.z = dot(cb1[10].xyz, r2.xyz);
  r1.x = dot(float3(1.37041235, -0.329292178, -0.0636831224), r0.xyz);
  r1.y = dot(float3(-0.083433494, 1.09709275, -0.0108613791), r0.xyz);
  r1.z = dot(float3(-0.0257933214, -0.0986258015, 1.20369494), r0.xyz);
  ...
  r1.xyz = log2(r1.xyz);
  r2.xyzw = cb0[21].xyzw * cb0[16].xyzw;
  r2.xyz = r2.xyz * r2.www;
  r1.xyz = r2.xyz * r1.xyz;
  r1.xyz = exp2(r1.xyz);
  r1.xyz = float3(0.180000007, 0.180000007, 0.180000007) * r1.xyz;
  r1.xyz = log2(r1.xyz);
  r2.xyzw = cb0[22].xyzw * cb0[17].xyzw;
  r2.xyz = r2.xyz * r2.www;
  r2.xyz = float3(1, 1, 1) / r2.xyz;
  r1.xyz = r2.xyz * r1.xyz;
  r1.xyz = exp2(r1.xyz);
  r2.xyzw = cb0[23].xyzw * cb0[18].xyzw;
  r2.xyz = r2.xyz * r2.www;
  r3.xyzw = cb0[24].xyzw + cb0[19].xyzw;
  r3.xyz = r3.xyz + r3.www;
  r1.xyz = r1.xyz * r2.xyz + r3.xyz;
  r2.xyzw = cb0[25].xyzw * cb0[15].xyzw;
  r2.xyz = r2.xyz * r2.www;
  r2.xyz = r2.xyz * r0.xyz + r0.www;
  r2.xyz = max(float3(0, 0, 0), r2.xyz);
  r2.xyz = float3(5.55555534, 5.55555534, 5.55555534) * r2.xyz;
  r2.xyz = log2(r2.xyz);
  r3.xyzw = cb0[26].xyzw * cb0[16].xyzw;
  r3.xyz = r3.xyz * r3.www;
  r2.xyz = r3.xyz * r2.xyz;
  r2.xyz = exp2(r2.xyz);
  r2.xyz = float3(0.180000007, 0.180000007, 0.180000007) * r2.xyz;
  r2.xyz = log2(r2.xyz);
  r3.xyzw = cb0[27].xyzw * cb0[17].xyzw;
  r3.xyz = r3.xyz * r3.www;
  r3.xyz = float3(1, 1, 1) / r3.xyz;
  r2.xyz = r3.xyz * r2.xyz;
  r2.xyz = exp2(r2.xyz);
  r3.xyzw = cb0[28].xyzw * cb0[18].xyzw;
  r3.xyz = r3.xyz * r3.www;
  r4.xyzw = cb0[29].xyzw + cb0[19].xyzw;
  ...
  r2.xyzw = cb0[30].xyzw * cb0[15].xyzw;
  r2.xyz = r2.xyz * r2.www;
  r0.xyz = r2.xyz * r0.xyz + r0.www;
  r0.xyz = max(float3(0, 0, 0), r0.xyz);
  r0.xyz = float3(5.55555534, 5.55555534, 5.55555534) * r0.xyz;
  r0.xyz = log2(r0.xyz);
  r2.xyzw = cb0[31].xyzw * cb0[16].xyzw;
  r2.xyz = r2.xyz * r2.www;
  r0.xyz = r2.xyz * r0.xyz;
  r0.xyz = exp2(r0.xyz);
  r0.xyz = float3(0.180000007, 0.180000007, 0.180000007) * r0.xyz;
  r0.xyz = log2(r0.xyz);
  r2.xyzw = cb0[32].xyzw * cb0[17].xyzw;
  r2.xyz = r2.xyz * r2.www;
  r2.xyz = float3(1, 1, 1) / r2.xyz;
  r0.xyz = r2.xyz * r0.xyz;
  r0.xyz = exp2(r0.xyz);
  r2.xyzw = cb0[33].xyzw * cb0[18].xyzw;
  r2.xyz = r2.xyz * r2.www;
  r4.xyzw = cb0[34].xyzw + cb0[19].xyzw;
  ...
  r0.xyz = r0.xyz * float3(0.947867274, 0.947867274, 0.947867274) + float3(0.0521326996, 0.0521326996, 0.0521326996);
  r0.xyz = log2(r0.xyz);
