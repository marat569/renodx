...
void main(
  ...
  float _918 = max(0.0f, mad((WorkingColorSpace.FromAP1[0].z), _908, mad((WorkingColorSpace.FromAP1[0].y), _907, ((WorkingColorSpace.FromAP1[0].x) * _906))));
  float _919 = max(0.0f, mad((WorkingColorSpace.FromAP1[1].z), _908, mad((WorkingColorSpace.FromAP1[1].y), _907, ((WorkingColorSpace.FromAP1[1].x) * _906))));
  float _920 = max(0.0f, mad((WorkingColorSpace.FromAP1[2].z), _908, mad((WorkingColorSpace.FromAP1[2].y), _907, ((WorkingColorSpace.FromAP1[2].x) * _906))));
