// Found in Eternal Strands Demo, UE 5.x
...
float4 main(
  ...
  SV_Target = ProcessLutbuilder(float3(_485, _487, _489), cb_config, SV_Target, OutputDevice);
  return SV_Target;
  ...
  float _850 = max(0.0f, mad((WorkingColorSpace_FromAP1[0].z), _828, mad((WorkingColorSpace_FromAP1[0].y), _827, ((WorkingColorSpace_FromAP1[0].x) * _826))));
  float _851 = max(0.0f, mad((WorkingColorSpace_FromAP1[1].z), _828, mad((WorkingColorSpace_FromAP1[1].y), _827, ((WorkingColorSpace_FromAP1[1].x) * _826))));
  float _852 = max(0.0f, mad((WorkingColorSpace_FromAP1[2].z), _828, mad((WorkingColorSpace_FromAP1[2].y), _827, ((WorkingColorSpace_FromAP1[2].x) * _826))));
  ...
  if (WorkingColorSpace_bIsSRGB == 0) {
    float _910 = mad((WorkingColorSpace_ToAP1[0].z), _903, mad((WorkingColorSpace_ToAP1[0].y), _902, ((WorkingColorSpace_ToAP1[0].x) * _901)));
    float _913 = mad((WorkingColorSpace_ToAP1[1].z), _903, mad((WorkingColorSpace_ToAP1[1].y), _902, ((WorkingColorSpace_ToAP1[1].x) * _901)));
    float _916 = mad((WorkingColorSpace_ToAP1[2].z), _903, mad((WorkingColorSpace_ToAP1[2].y), _902, ((WorkingColorSpace_ToAP1[2].x) * _901)));
