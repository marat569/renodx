...
float3 ApplyToneCurveExtendedWithHermite(
  ...
  tonemapped_prebluecorrect_ap1 = renodx::color::ap1::from::BT709(CorrectHueAndChrominanceOKLab(bt709_tonemapped_prebluecorrect, bt709_hue_and_chrominance_source, RENODX_TONE_MAP_HUE_SHIFT, RENODX_TONE_MAP_CHROMA_CORRECT_BLOWOUT, 1.1f));
