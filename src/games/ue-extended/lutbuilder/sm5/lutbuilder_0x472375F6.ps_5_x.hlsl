...
// ---- Created with 3Dmigoto v1.3.16 on Sun Jul  6 02:59:07 2025
...
void main(
  ...
  r0.xyz = bUseMobileTonemapper ? r1.xyz : r0.xyz;
  ...
  float4 lutweights[2] = { float4(asfloat(LUTWeights[0]), asfloat(LUTWeights[1]), 0.f, 0.f), float4(0.f, 0.f, 0.f, 0.f) };
  cb_config.ue_lutweights = lutweights;  // Only Lutweights[0].xy is used

  o0 = ProcessLutbuilder(float3(untonemapped_ap1), Samplers_1_s, Textures_1, cb_config, o0, OutputDevice);
  return;
