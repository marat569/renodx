// Infinity Nikki (UE 5.4.4)

#include "../lutbuilderoutput.hlsli"

// ---- Created with 3Dmigoto v1.4.1 on Thu Dec 26 02:00:26 2024
...
void main(
  ...
  r0.x = (uint)v2.x;
  r1.z = r0.x / r0.z;
  r0.xyzw = cmp(int4(1, 2, 3, 4) == asint(cb0[41].xxxx));
  r2.xyz = r0.www ? float3(1, 0, 0) : float3(1.70505095, -0.621792138, -0.0832588747);
  r3.xyz = r0.www ? float3(0, 1, 0) : float3(-0.130256414, 1.14080477, -0.0105483187);
  r4.xyz = r0.www ? float3(0, 0, 1) : float3(-0.0240033567, -0.128968969, 1.15297234);
  r2.xyz = r0.zzz ? float3(0.695452213, 0.140678704, 0.163869068) : r2.xyz;
  r3.xyz = r0.zzz ? float3(0.0447945632, 0.859671116, 0.0955343172) : r3.xyz;
  r4.xyz = r0.zzz ? float3(-0.00552588282, 0.00402521016, 1.00150073) : r4.xyz;
  r2.xyz = r0.yyy ? float3(1.02582479, -0.0200531911, -0.00577155687) : r2.xyz;
  r3.xyz = r0.yyy ? float3(-0.00223436952, 1.00458646, -0.00235213246) : r3.xyz;
  r0.yzw = r0.yyy ? float3(-0.00501335133, -0.025290072, 1.03030348) : r4.xyz;
  r2.xyz = r0.xxx ? float3(1.37921417, -0.308864146, -0.0703499839) : r2.xyz;
  r3.xyz = r0.xxx ? float3(-0.0693348572, 1.08229673, -0.0129618878) : r3.xyz;
  r0.xyz = r0.xxx ? float3(-0.00215900945, -0.0454593264, 1.04761839) : r0.yzw;
  r0.w = cmp(asuint(cb0[40].w) >= 3);
  r4.xyz = log2(r1.xyz);
  ...
  r4.xyz = exp2(r4.xyz);
  r4.xyz = float3(100, 100, 100) * r4.xyz;
  ...
  r0.w = cb0[35].y * 1.00055635;
  r0.w = 1 / r0.w;
  r1.w = cmp(6996.10791 >= cb0[35].y);
  ...
  r5.xyz = cb0[35].yyy * float3(0.000154118257, 0.00084242021, 4.22806261e-05) + float3(0.860117733, 1, 0.317398727);
  r0.w = cb0[35].y * cb0[35].y;
  r5.xyz = r0.www * float3(1.28641219e-07, 7.08145137e-07, 4.20481676e-08) + r5.xyz;
  r1.w = r5.x / r5.y;
  r5.xyw = -cb0[35].yyy * float3(2.8974182e-05, 1916156.25, 705674) + float3(1, -1.13758118e+09, 1.97471539e+09);
  ...
  r1.x = dot(cb1[8].xyz, r5.xyz);
  r1.y = dot(cb1[9].xyz, r5.xyz);
  r1.z = dot(cb1[10].xyz, r5.xyz);
  ...
  r0.w = 1 + -r0.w;
  r0.w = r1.w * r0.w;
  r4.x = dot(float3(1.37041235, -0.329292178, -0.0636831224), r1.xyz);
  r4.y = dot(float3(-0.083433494, 1.09709275, -0.0108613791), r1.xyz);
  r4.z = dot(float3(-0.0257933214, -0.0986258015, 1.20369494), r1.xyz);
  r4.xyz = r4.xyz + -r1.xyz;
  r1.xyz = r0.www * r4.xyz + r1.xyz;
  r0.w = dot(r1.xyz, float3(0.272228718, 0.674081743, 0.0536895171));
  r4.xyzw = cb0[20].xyzw * cb0[15].xyzw;
  ...
  cb_config.ue_filmblackclip = asfloat(cb0[38].x);
  cb_config.ue_filmtoe = asfloat(cb0[37].z);
  cb_config.ue_filmshoulder = asfloat(cb0[37].w);
  cb_config.ue_filmslope = asfloat(cb0[37].y);
  cb_config.ue_filmwhiteclip = asfloat(cb0[38].y);
  cb_config.ue_tonecurveammount = asfloat(cb0[37].x);
  ...
  r6.xyz = cb0[38].xyx + float3(1, 1, 0.180000007);
  r6.xw = -cb0[37].zw + r6.xy;
  r0.w = cmp(0.800000012 < cb0[37].z);
  r7.xy = -cb0[37].zz + float2(0.819999993, 1);
  r7.xy = r7.xy / cb0[37].yy;
  r1.w = -0.744727492 + r7.x;
  r2.w = r6.z / r6.x;
  r3.w = -1 + r2.w;
  r3.w = 1 + -r3.w;
  r2.w = r2.w / r3.w;
  ...
  r0.w = r0.w ? r1.w : r2.w;
  r1.w = r7.y + -r0.w;
  r2.w = cb0[37].w / cb0[37].y;
  r2.w = r2.w + -r1.w;
  r5.xyz = log2(r5.xyz);
  r7.xyz = float3(0.30103001, 0.30103001, 0.30103001) * r5.xyz;
  r8.xyz = r5.xyz * float3(0.30103001, 0.30103001, 0.30103001) + r1.www;
  r8.xyz = cb0[37].yyy * r8.xyz;
  r9.xy = r6.xw + r6.xw;
  r1.w = cb0[37].y * -2;
  r1.w = r1.w / r6.x;
  r10.xyz = r5.xyz * float3(0.30103001, 0.30103001, 0.30103001) + -r0.www;
  r11.xyz = r10.xyz * r1.www;
  r11.xyz = float3(1.44269502, 1.44269502, 1.44269502) * r11.xyz;
  r11.xyz = exp2(r11.xyz);
  r11.xyz = float3(1, 1, 1) + r11.xyz;
  r9.xzw = r9.xxx / r11.xyz;
  r9.xzw = -cb0[38].xxx + r9.xzw;
  r1.w = cb0[37].y + cb0[37].y;
  r1.w = r1.w / r6.w;
  r5.xyz = r5.xyz * float3(0.30103001, 0.30103001, 0.30103001) + -r2.www;
  ...
  r6.xyz = cmp(r7.xyz < r0.www);
  r6.xyz = r6.xyz ? r9.xzw : r8.xyz;
  r7.xyz = cmp(r2.www < r7.xyz);
  r5.xyz = r7.xyz ? r5.xyz : r8.xyz;
  r1.w = r2.w + -r0.w;
  r7.xyz = saturate(r10.xyz / r1.www);
  r0.w = cmp(r2.w < r0.w);
  ...
  r4.xyz = cb0[37].xxx * r5.xyz + r4.xyz;
  r5.x = dot(float3(1.06537485, 1.44678506e-06, -0.0653710067), r4.xyz);
  r5.y = dot(float3(-3.45525592e-07, 1.20366347, -0.203667715), r4.xyz);
  r5.z = dot(float3(1.9865448e-08, 2.12079581e-08, 0.999999583), r4.xyz);
  r5.xyz = r5.xyz + -r4.xyz;
  r4.xyz = cb0[36].zzz * r5.xyz + r4.xyz;

  //SetTonemappedAP1(r4.xyz);

  r5.x = saturate(dot(cb1[12].xyz, r4.xyz));
  r5.y = saturate(dot(cb1[13].xyz, r4.xyz));
  r5.z = saturate(dot(cb1[14].xyz, r4.xyz));
  r4.xyz = float3(12.9200001, 12.9200001, 12.9200001) * r5.xyz;
  ...
  r5.yzw = r4.xyz * float3(0.9375, 0.9375, 0.9375) + float3(0.03125, 0.03125, 0.03125);
  r0.w = r5.w * 16 + -0.5;
  r1.w = floor(r0.w);
  r0.w = -r1.w + r0.w;
  r1.w = r5.y + r1.w;
  ...
  r4.xyz = cb0[5].xxx * r4.xyz + r5.xyz;
  r4.xyz = max(float3(6.10351999e-05, 6.10351999e-05, 6.10351999e-05), r4.xyz);
  r5.xyz = cmp(float3(0.0404499993, 0.0404499993, 0.0404499993) < r4.xyz);
  r6.xyz = r4.xyz * float3(0.947867274, 0.947867274, 0.947867274) + float3(0.0521326996, 0.0521326996, 0.0521326996);
  r6.xyz = log2(r6.xyz);
  ...
  r4.xyz = cb0[39].xxx * r5.xyz + r4.xyz;
  r4.xyz = cb0[39].zzz + r4.xyz;
  r5.xyz = cb0[14].xyz * r4.xyz;
  r4.xyz = -r4.xyz * cb0[14].xyz + cb0[13].xyz;
  r4.xyz = cb0[13].www * r4.xyz + r5.xyz;
  ...
  if (asuint(cb0[40].w) == 0) {
    ...
    if (r0.w != 0) {
      ...
      r8.x = dot(r2.xyz, r7.xyz);
      r8.y = dot(r3.xyz, r7.xyz);
      r8.z = dot(r0.xyz, r7.xyz);
      ...
      r7.x = dot(cb1[12].xyz, r1.xyz);
      r7.y = dot(cb1[13].xyz, r1.xyz);
      r7.z = dot(cb1[14].xyz, r1.xyz);
      r1.xyz = cb0[14].xyz * r7.xyz;
      r7.xyz = -r7.xyz * cb0[14].xyz + cb0[13].xyz;
      r1.xyz = cb0[13].www * r7.xyz + r1.xyz;
      r7.xy = cmp(int2(3, 5) == asint(cb0[40].ww));
      r0.w = (int)r7.y | (int)r7.x;
      if (r0.w != 0) {
        r7.xyz = cb0[12].zzz * r1.xyz;
        r8.y = dot(cb1[16].xyz, r7.xyz);
        r8.z = dot(cb1[17].xyz, r7.xyz);
        r8.w = dot(cb1[18].xyz, r7.xyz);
        r7.x = dot(float3(1.45143926, -0.236510754, -0.214928567), r8.yzw);
        r7.y = dot(float3(-0.0765537769, 1.17622972, -0.0996759236), r8.yzw);
        r7.z = dot(float3(0.00831614807, -0.00603244966, 0.997716308), r8.yzw);
        r0.w = max(r7.y, r7.z);
        r0.w = max(r7.x, r0.w);
        r1.w = cmp(r0.w < 1.00000001e-10);
        r9.xyz = cmp(r8.yzw < float3(0, 0, 0));
        r2.w = (int)r9.y | (int)r9.x;
        r2.w = (int)r9.z | (int)r2.w;
        r1.w = (int)r1.w | (int)r2.w;
        if (r1.w == 0) {
          r9.xyz = r0.www + -r7.xyz;
          r9.xyz = r9.xyz / abs(r0.www);
          r10.xyz = cmp(r9.xyz < float3(0.814999998, 0.802999973, 0.879999995));
          r11.xyz = float3(-0.814999998, -0.802999973, -0.879999995) + r9.xyz;
          r12.xyzw = float4(3.05528307, 1, 3.49726105, 1) * r11.xxyy;
          r11.xy = log2(r12.xz);
          r11.xy = float2(1.20000005, 1.20000005) * r11.xy;
          r11.xy = exp2(r11.xy);
          r11.xy = float2(1, 1) + r11.xy;
          r11.xy = log2(r11.xy);
          r11.xy = float2(0.833333313, 0.833333313) * r11.xy;
          r11.xy = exp2(r11.xy);
          r11.xy = r12.yw / r11.xy;
          r11.xy = float2(0.814999998, 0.802999973) + r11.xy;
          r9.xy = r10.xy ? r9.xy : r11.xy;
          r10.xy = float2(6.81099463, 1) * r11.zz;
          r1.w = log2(r10.x);
          r1.w = 1.20000005 * r1.w;
          r1.w = exp2(r1.w);
          r1.w = 1 + r1.w;
          r1.w = log2(r1.w);
          r1.w = 0.833333313 * r1.w;
          r1.w = exp2(r1.w);
          r1.w = r10.y / r1.w;
          r1.w = 0.879999995 + r1.w;
          r1.w = r10.z ? r9.z : r1.w;
          r7.xy = -r9.xy * abs(r0.ww) + r0.ww;
          r7.z = -r1.w * abs(r0.w) + r0.w;
        }
        r9.y = dot(float3(0.695452213, 0.140678704, 0.163869068), r7.xyz);
        r9.z = dot(float3(0.0447945632, 0.859671116, 0.0955343172), r7.xyz);
        r9.w = dot(float3(-0.00552588282, 0.00402521016, 1.00150073), r7.xyz);
        r7.xyz = r9.yzw + -r8.yzw;
        r7.xyz = cb0[12].www * r7.xyz + r8.yzw;
        r0.w = min(r7.x, r7.y);
        r0.w = min(r0.w, r7.z);
        r1.w = max(r7.x, r7.y);
        r1.w = max(r1.w, r7.z);
        ...
        r1.w = r4.w ? r3.w : r1.w;
        r1.w = 1 + r1.w;
        r8.yzw = r7.xyz * r1.www;
        r9.xy = cmp(r8.zw == r8.yz);
        r2.w = r9.y ? r9.x : 0;
        r3.w = r7.y * r1.w + -r8.w;
        r3.w = 1.73205078 * r3.w;
        r4.w = r8.y * 2 + -r8.z;
        ...
        if (r3.w != 0) {
          ...
          r3.w = r2.w * r2.w;
          r5.w = r3.w * r2.w;
          r7.yzw = float3(-0.166666672, -0.5, 0.166666672) * r5.www;
          r7.yz = r3.ww * float2(0.5, 0.5) + r7.yz;
          r7.yz = r2.ww * float2(-0.5, 0.5) + r7.yz;
          r2.w = r5.w * 0.5 + -r3.w;
          r2.w = 0.666666687 + r2.w;
          r9.xyz = cmp((int3)r4.www == int3(3, 2, 1));
          r7.yz = float2(0.166666672, 0.166666672) + r7.yz;
          r3.w = r4.w ? 0 : r7.w;
          r3.w = r9.z ? r7.z : r3.w;
          r2.w = r9.y ? r2.w : r3.w;
          r2.w = r9.x ? r7.y : r2.w;
        ...
        r0.w = r2.w * r0.w;
        r0.w = 1.5 * r0.w;
        r1.w = -r7.x * r1.w + 0.0299999993;
        r0.w = r1.w * r0.w;
        r8.x = r0.w * 0.180000007 + r8.y;
        r7.xyz = max(float3(0, 0, 0), r8.xzw);
        ...
        if (r0.w != 0) {
          ...
          if (r0.w != 0) {
            r7.x = dot(cb1[8].xyz, r1.xyz);
            r7.y = dot(cb1[9].xyz, r1.xyz);
            r7.z = dot(cb1[10].xyz, r1.xyz);
            r8.x = dot(r2.xyz, r7.xyz);
            r8.y = dot(r3.xyz, r7.xyz);
            r8.z = dot(r0.xyz, r7.xyz);
            ...
            r8.x = dot(cb1[8].xyz, r4.xyz);
            r8.y = dot(cb1[9].xyz, r4.xyz);
            r8.z = dot(cb1[10].xyz, r4.xyz);
            r4.x = dot(r2.xyz, r8.xyz);
            r4.y = dot(r3.xyz, r8.xyz);
            ...
            r0.x = dot(r0.xyz, r8.xyz);
            r2.x = log2(r0.w);
            r2.y = log2(r1.w);
            r2.z = log2(r0.x);
            r0.xyz = cb0[40].zzz * r2.xyz;
            r0.xyz = exp2(r0.xyz);
            r0.xyz = r7.yyy ? r4.xyz : r0.xyz;
            r6.xyz = r7.xxx ? r1.xyz : r0.xyz;
          }
        }
      }
    }
