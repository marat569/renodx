...
#ifndef SRC_ENOTRIA_SHARED_H_
#define SRC_ENOTRIA_SHARED_H_
...
// 0 = HDR10, 1 = scRGB
#define RENODX_SWAP_CHAIN_ENCODING_COLOR_SPACE (color::convert::COLOR_SPACE_BT2020 - 0)  // BT709 = BT2020 - 1
#define RENODX_SWAP_CHAIN_ENCODING             (ENCODING_PQ + 0)                         // SCRGB = PQ + 1
