...
float4 main(
  ...
  _30 = float((uint)(int)(SV_RenderTargetArrayIndex)) / _26;
  if (!(cb0_045x == 1)) {
    if (!(cb0_045x == 2)) {
      if (!(cb0_045x == 3)) {
        _39 = (cb0_045x == 4);
  ...
  _409 = (_400 / _404) + -1.0f;
  _410 = (_403 / _404) + -1.0f;
  // _422 = (1.0f - exp2(((_404 * _404) * -4.0f) * cb0_038w)) * (1.0f - exp2(dot(float3(_408, _409, _410), float3(_408, _409, _410)) * -4.0f));
  _422 = (1.0f - exp2(((_404 * _404) * -4.0f) * 0.0f)) * (1.0f - exp2(dot(float3(_408, _409, _410), float3(_408, _409, _410)) * -4.0f));
  ...
  _846 = ((mad(0.169205904006958f, _809, mad(0.8307942152023315f, _807, (_805 * 6.775371730327606e-08f))) - _807) * cb0_038z) + _807;
  _847 = (mad(-2.3283064365386963e-10f, _807, (_805 * -9.313225746154785e-10f)) * cb0_038z) + _809;
  _859 = ((cb0_040w - cb0_041y) * cb0_041z) / cb0_041x;
  _860 = _845 - cb0_041y;
  _863 = _845 / cb0_041y;
  _872 = cb0_040w - ((_859 * cb0_041x) + cb0_041y);
  _873 = (cb0_040w * cb0_041x) / _872;
  if (_845 > 0.0f) {
    if (_845 < cb0_041y) {
  ...
  _1006 = (cb0_039x * (((((1.0f - _891) * (((pow(_863, cb0_042x)) * cb0_041y) + cb0_041w)) - _845) + (_903 * (cb0_040w - (exp2(((-0.0f - ((_860 - _859) * _873)) / cb0_040w) * 1.442694067955017f) * _872)))) + ((_891 - _903) * ((cb0_041x * _860) + cb0_041y)))) + _845;
  _1007 = (cb0_039x * (((((1.0f - _934) * (((pow(_911, cb0_042x)) * cb0_041y) + cb0_041w)) - _846) + (_945 * (cb0_040w - (exp2(((-0.0f - ((_908 - _859) * _873)) / cb0_040w) * 1.442694067955017f) * _872)))) + ((_934 - _945) * ((cb0_041x * _908) + cb0_041y)))) + _846;
  _1008 = ((((((1.0f - _976) * (((pow(_953, cb0_042x)) * cb0_041y) + cb0_041w)) - _847) + (_987 * (cb0_040w - (exp2(((-0.0f - ((_950 - _859) * _873)) / cb0_040w) * 1.442694067955017f) * _872)))) + ((_976 - _987) * ((cb0_041x * _950) + cb0_041y))) * cb0_039x) + _847;
  _1024 = ((mad(-0.06537103652954102f, _1008, mad(1.451815478503704e-06f, _1007, (_1006 * 1.065374732017517f))) - _1006) * cb0_038z) + _1006;
  _1025 = ((mad(-0.20366770029067993f, _1008, mad(1.2036634683609009f, _1007, (_1006 * -2.57161445915699e-07f))) - _1007) * cb0_038z) + _1007;
  _1026 = ((mad(0.9999996423721313f, _1008, mad(2.0954757928848267e-08f, _1007, (_1006 * 1.862645149230957e-08f))) - _1008) * cb0_038z) + _1008;
  _1036 = max(0.0f, mad((WorkingColorSpace_192[0].z), _1026, mad((WorkingColorSpace_192[0].y), _1025, ((WorkingColorSpace_192[0].x) * _1024))));
  _1037 = max(0.0f, mad((WorkingColorSpace_192[1].z), _1026, mad((WorkingColorSpace_192[1].y), _1025, ((WorkingColorSpace_192[1].x) * _1024))));
  _1038 = max(0.0f, mad((WorkingColorSpace_192[2].z), _1026, mad((WorkingColorSpace_192[2].y), _1025, ((WorkingColorSpace_192[2].x) * _1024))));
  _1064 = cb0_016x * (((cb0_043y + (cb0_043x * _1036)) * _1036) + cb0_043z);
  _1065 = cb0_016y * (((cb0_043y + (cb0_043x * _1037)) * _1037) + cb0_043z);
  _1066 = cb0_016z * (((cb0_043y + (cb0_043x * _1038)) * _1038) + cb0_043z);
  _1073 = ((cb0_015x - _1064) * cb0_015w) + _1064;
  _1074 = ((cb0_015y - _1065) * cb0_015w) + _1065;
  _1075 = ((cb0_015z - _1066) * cb0_015w) + _1066;
  _1076 = cb0_016x * mad((WorkingColorSpace_192[0].z), _809, mad((WorkingColorSpace_192[0].y), _807, (_805 * (WorkingColorSpace_192[0].x))));
  _1077 = cb0_016y * mad((WorkingColorSpace_192[1].z), _809, mad((WorkingColorSpace_192[1].y), _807, ((WorkingColorSpace_192[1].x) * _805)));
  _1078 = cb0_016z * mad((WorkingColorSpace_192[2].z), _809, mad((WorkingColorSpace_192[2].y), _807, ((WorkingColorSpace_192[2].x) * _805)));
  _1085 = ((cb0_015x - _1076) * cb0_015w) + _1076;
  _1086 = ((cb0_015y - _1077) * cb0_015w) + _1077;
  _1087 = ((cb0_015z - _1078) * cb0_015w) + _1078;
  _1099 = exp2(log2(max(0.0f, _1073)) * cb0_044y);
  _1100 = exp2(log2(max(0.0f, _1074)) * cb0_044y);
  _1101 = exp2(log2(max(0.0f, _1075)) * cb0_044y);
  [branch]
  if (cb0_044w == 0) {
    if (WorkingColorSpace_384 == 0) {
      _1116 = mad((WorkingColorSpace_128[0].z), _1101, mad((WorkingColorSpace_128[0].y), _1100, ((WorkingColorSpace_128[0].x) * _1099)));
      _1119 = mad((WorkingColorSpace_128[1].z), _1101, mad((WorkingColorSpace_128[1].y), _1100, ((WorkingColorSpace_128[1].x) * _1099)));
      _1122 = mad((WorkingColorSpace_128[2].z), _1101, mad((WorkingColorSpace_128[2].y), _1100, ((WorkingColorSpace_128[2].x) * _1099)));
    ...
    if (cb0_044w == 1) {
      _1176 = mad((WorkingColorSpace_128[0].z), _1101, mad((WorkingColorSpace_128[0].y), _1100, ((WorkingColorSpace_128[0].x) * _1099)));
      _1179 = mad((WorkingColorSpace_128[1].z), _1101, mad((WorkingColorSpace_128[1].y), _1100, ((WorkingColorSpace_128[1].x) * _1099)));
      _1182 = mad((WorkingColorSpace_128[2].z), _1101, mad((WorkingColorSpace_128[2].y), _1100, ((WorkingColorSpace_128[2].x) * _1099)));
      _1185 = mad(_52, _1182, mad(_51, _1179, (_1176 * _50)));
      _1188 = mad(_55, _1182, mad(_54, _1179, (_1176 * _53)));
      _1191 = mad(_58, _1182, mad(_57, _1179, (_1176 * _56)));
      ...
      if ((uint)((uint)((int)(cb0_044w) + (uint)(-3))) < (uint)2) {
        ...
        _9[4] = cb0_012y;
        _9[5] = cb0_012y;
        _1266 = cb0_012z * _1085;
        _1267 = cb0_012z * _1086;
        _1268 = cb0_012z * _1087;
        _1271 = mad((WorkingColorSpace_256[0].z), _1268, mad((WorkingColorSpace_256[0].y), _1267, ((WorkingColorSpace_256[0].x) * _1266)));
        _1274 = mad((WorkingColorSpace_256[1].z), _1268, mad((WorkingColorSpace_256[1].y), _1267, ((WorkingColorSpace_256[1].x) * _1266)));
        _1277 = mad((WorkingColorSpace_256[2].z), _1268, mad((WorkingColorSpace_256[2].y), _1267, ((WorkingColorSpace_256[2].x) * _1266)));
        _1280 = mad(-0.21492856740951538f, _1277, mad(-0.2365107536315918f, _1274, (_1271 * 1.4514392614364624f)));
        _1283 = mad(-0.09967592358589172f, _1277, mad(1.17622971534729f, _1274, (_1271 * -0.07655377686023712f)));
        _1286 = mad(0.9977163076400757f, _1277, mad(-0.006032449658960104f, _1274, (_1271 * 0.008316148072481155f)));
        _1288 = max(_1280, max(_1283, _1286));
        if (!(_1288 < 1.000000013351432e-10f)) {
          if (!(((bool)((bool)(_1271 < 0.0f) || (bool)(_1274 < 0.0f))) || (bool)(_1277 < 0.0f))) {
            _1298 = abs(_1288);
            _1299 = (_1288 - _1280) / _1298;
            _1301 = (_1288 - _1283) / _1298;
            _1303 = (_1288 - _1286) / _1298;
            if (!(_1299 < 0.8149999976158142f)) {
              _1306 = _1299 + -0.8149999976158142f;
            ...
            if (!(_1301 < 0.8029999732971191f)) {
              _1321 = _1301 + -0.8029999732971191f;
            ...
            if (!(_1303 < 0.8799999952316284f)) {
              _1336 = _1303 + -0.8799999952316284f;
        ...
        _1374 = ((mad(0.16386906802654266f, _1358, mad(0.14067870378494263f, _1357, (_1356 * 0.6954522132873535f))) - _1271) * cb0_012w) + _1271;
        _1375 = ((mad(0.0955343171954155f, _1358, mad(0.8596711158752441f, _1357, (_1356 * 0.044794563204050064f))) - _1274) * cb0_012w) + _1274;
        _1376 = ((mad(1.0015007257461548f, _1358, mad(0.004025210160762072f, _1357, (_1356 * -0.005525882821530104f))) - _1277) * cb0_012w) + _1277;
        _1380 = max(max(_1374, _1375), _1376);
        _1385 = (max(_1380, 1.000000013351432e-10f) - max(min(min(_1374, _1375), _1376), 1.000000013351432e-10f)) / max(_1380, 0.009999999776482582f);
        _1398 = ((_1375 + _1374) + _1376) + (sqrt((((_1376 - _1375) * _1376) + ((_1375 - _1374) * _1375)) + ((_1374 - _1376) * _1374)) * 1.75f);
        _1399 = _1398 * 0.3333333432674408f;
        _1400 = _1385 + -0.4000000059604645f;
        _1401 = _1400 * 5.0f;
        _1405 = max((1.0f - abs(_1400 * 2.5f)), 0.0f);
        _1416 = ((float((int)(((int)(uint)((bool)(_1401 > 0.0f))) - ((int)(uint)((bool)(_1401 < 0.0f))))) * (1.0f - (_1405 * _1405))) + 1.0f) * 0.02500000037252903f;
        ...
        if (!((bool)(_1427 == _1428) && (bool)(_1428 == _1429))) {
          _1436 = ((_1427 * 2.0f) - _1428) - _1429;
          _1439 = ((_1375 - _1376) * 1.7320507764816284f) * _1426;
          _1441 = atan(_1439 / _1436);
          _1444 = (_1436 < 0.0f);
          _1445 = (_1436 == 0.0f);
          _1446 = (_1439 >= 0.0f);
          _1447 = (_1439 < 0.0f);
        ...
        _1463 = min(max(select((_1458 < 0.0f), (_1458 + 360.0f), _1458), 0.0f), 360.0f);
        if (_1463 < -180.0f) {
          _1472 = (_1463 + 360.0f);
        } else {
          if (_1463 > 180.0f) {
        ...
        if ((bool)(_1472 > -67.5f) && (bool)(_1472 < 67.5f)) {
          _1478 = (_1472 + 67.5f) * 0.029629629105329514f;
          _1479 = int(_1478);
          _1481 = _1478 - float((int)(_1479));
          _1482 = _1481 * _1481;
          _1483 = _1482 * _1481;
          if (_1479 == 3) {
        ...
        _1520 = min(max(((((_1385 * 0.27000001072883606f) * (0.029999999329447746f - _1427)) * _1511) + _1427), 0.0f), 65535.0f);
        _1521 = min(max(_1428, 0.0f), 65535.0f);
        _1522 = min(max(_1429, 0.0f), 65535.0f);
        _1535 = min(max(mad(-0.21492856740951538f, _1522, mad(-0.2365107536315918f, _1521, (_1520 * 1.4514392614364624f))), 0.0f), 65504.0f);
        _1536 = min(max(mad(-0.09967592358589172f, _1522, mad(1.17622971534729f, _1521, (_1520 * -0.07655377686023712f))), 0.0f), 65504.0f);
        _1537 = min(max(mad(0.9977163076400757f, _1522, mad(-0.006032449658960104f, _1521, (_1520 * 0.008316148072481155f))), 0.0f), 65504.0f);
        _1538 = dot(float3(_1535, _1536, _1537), float3(0.2722287178039551f, 0.6740817427635193f, 0.053689517080783844f));
        _16[0] = cb0_010x;
        _16[1] = cb0_010y;
        _16[2] = cb0_010z;
        _16[3] = cb0_010w;
        ...
        _17[4] = cb0_012y;
        _17[5] = cb0_012y;
        _1561 = log2(max((lerp(_1538, _1535, 0.9599999785423279f)), 1.000000013351432e-10f));
        _1562 = _1561 * 0.3010300099849701f;
        _1563 = log2(cb0_008x);
        _1564 = _1563 * 0.3010300099849701f;
        if (_1562 > _1564) {
          _1571 = log2(cb0_009x);
          _1572 = _1571 * 0.3010300099849701f;
          if ((bool)(_1562 > _1564) && (bool)(_1562 < _1572)) {
            _1580 = ((_1561 - _1563) * 0.9030900001525879f) / ((_1571 - _1563) * 0.3010300099849701f);
            _1581 = int(_1580);
            _1583 = _1580 - float((int)(_1581));
            _1585 = _16[_1581];
            _1588 = _16[(_1581 + 1)];
            _1593 = _1585 * 0.5f;
            ...
            if ((_1562 < _1572) || ((!(_1562 < _1572)) && (!(_1562 < ((log2(cb0_008z)) * 0.3010300099849701f))))) {
              _1633 = (log2(cb0_008w) * 0.3010300099849701f);
            } else {
              _1610 = ((_1561 - _1571) * 0.9030900001525879f) / ((_1602 - _1571) * 0.3010300099849701f);
              _1611 = int(_1610);
              _1613 = _1610 - float((int)(_1611));
              _1615 = _17[_1611];
              _1618 = _17[(_1611 + 1)];
              _1623 = _1615 * 0.5f;
        ...
        _18[4] = cb0_012y;
        _18[5] = cb0_012y;
        _1643 = log2(max((lerp(_1538, _1536, 0.9599999785423279f)), 1.000000013351432e-10f));
        _1644 = _1643 * 0.3010300099849701f;
        if (_1644 > _1564) {
          _1651 = log2(cb0_009x);
          _1652 = _1651 * 0.3010300099849701f;
          if ((bool)(_1644 > _1564) && (bool)(_1644 < _1652)) {
            _1660 = ((_1643 - _1563) * 0.9030900001525879f) / ((_1651 - _1563) * 0.3010300099849701f);
            _1661 = int(_1660);
            _1663 = _1660 - float((int)(_1661));
            _1665 = _8[_1661];
            _1668 = _8[(_1661 + 1)];
            _1673 = _1665 * 0.5f;
            _1713 = dot(float3((_1663 * _1663), _1663, 1.0f), float3(mad((_8[(_1661 + 2)]), 0.5f, mad(_1668, -1.0f, _1673)), (_1668 - _1665), mad(_1668, 0.5f, _1673)));
          } else {
            if ((_1644 < _1652) || ((!(_1644 < _1652)) && (!(_1644 < ((log2(cb0_008z)) * 0.3010300099849701f))))) {
              _1713 = (log2(cb0_008w) * 0.3010300099849701f);
            } else {
              _1690 = ((_1643 - _1651) * 0.9030900001525879f) / ((_1682 - _1651) * 0.3010300099849701f);
              _1691 = int(_1690);
              _1693 = _1690 - float((int)(_1691));
              _1695 = _18[_1691];
              _1698 = _18[(_1691 + 1)];
              _1703 = _1695 * 0.5f;
        ...
        _1717 = log2(max((lerp(_1538, _1537, 0.9599999785423279f)), 1.000000013351432e-10f));
        _1718 = _1717 * 0.3010300099849701f;
        if (_1718 > _1564) {
          _1725 = log2(cb0_009x);
          _1726 = _1725 * 0.3010300099849701f;
          if ((bool)(_1718 > _1564) && (bool)(_1718 < _1726)) {
            _1734 = ((_1717 - _1563) * 0.9030900001525879f) / ((_1725 - _1563) * 0.3010300099849701f);
            _1735 = int(_1734);
            _1737 = _1734 - float((int)(_1735));
            _1739 = _8[_1735];
            _1742 = _8[(_1735 + 1)];
            _1747 = _1739 * 0.5f;
            _1787 = dot(float3((_1737 * _1737), _1737, 1.0f), float3(mad((_8[(_1735 + 2)]), 0.5f, mad(_1742, -1.0f, _1747)), (_1742 - _1739), mad(_1742, 0.5f, _1747)));
          } else {
            if ((_1718 < _1726) || ((!(_1718 < _1726)) && (!(_1718 < ((log2(cb0_008z)) * 0.3010300099849701f))))) {
              _1787 = (log2(cb0_008w) * 0.3010300099849701f);
            } else {
              _1764 = ((_1717 - _1725) * 0.9030900001525879f) / ((_1756 - _1725) * 0.3010300099849701f);
              _1765 = int(_1764);
              _1767 = _1764 - float((int)(_1765));
              _1769 = _9[_1765];
              _1772 = _9[(_1765 + 1)];
              _1777 = _1769 * 0.5f;
        ...
        _1791 = cb0_008w - cb0_008y;
        _1792 = (exp2(_1633 * 3.321928024291992f) - cb0_008y) / _1791;
        _1794 = (exp2(_1713 * 3.321928024291992f) - cb0_008y) / _1791;
        _1796 = (exp2(_1787 * 3.321928024291992f) - cb0_008y) / _1791;
        _1799 = mad(0.15618768334388733f, _1796, mad(0.13400420546531677f, _1794, (_1792 * 0.6624541878700256f)));
        _1802 = mad(0.053689517080783844f, _1796, mad(0.6740817427635193f, _1794, (_1792 * 0.2722287178039551f)));
        _1805 = mad(1.0103391408920288f, _1796, mad(0.00406073359772563f, _1794, (_1792 * -0.005574649665504694f)));
        _1818 = min(max(mad(-0.23642469942569733f, _1805, mad(-0.32480329275131226f, _1802, (_1799 * 1.6410233974456787f))), 0.0f), 1.0f);
        _1819 = min(max(mad(0.016756348311901093f, _1805, mad(1.6153316497802734f, _1802, (_1799 * -0.663662850856781f))), 0.0f), 1.0f);
        _1820 = min(max(mad(0.9883948564529419f, _1805, mad(-0.008284442126750946f, _1802, (_1799 * 0.011721894145011902f))), 0.0f), 1.0f);
        _1823 = mad(0.15618768334388733f, _1820, mad(0.13400420546531677f, _1819, (_1818 * 0.6624541878700256f)));
        _1826 = mad(0.053689517080783844f, _1820, mad(0.6740817427635193f, _1819, (_1818 * 0.2722287178039551f)));
        _1829 = mad(1.0103391408920288f, _1820, mad(0.00406073359772563f, _1819, (_1818 * -0.005574649665504694f)));
        _1851 = min(max((min(max(mad(-0.23642469942569733f, _1829, mad(-0.32480329275131226f, _1826, (_1823 * 1.6410233974456787f))), 0.0f), 65535.0f) * cb0_008w), 0.0f), 65535.0f);
        _1852 = min(max((min(max(mad(0.016756348311901093f, _1829, mad(1.6153316497802734f, _1826, (_1823 * -0.663662850856781f))), 0.0f), 65535.0f) * cb0_008w), 0.0f), 65535.0f);
        _1853 = min(max((min(max(mad(0.9883948564529419f, _1829, mad(-0.008284442126750946f, _1826, (_1823 * 0.011721894145011902f))), 0.0f), 65535.0f) * cb0_008w), 0.0f), 65535.0f);
        _1872 = exp2(log2(mad(_52, _1853, mad(_51, _1852, (_1851 * _50))) * 9.999999747378752e-05f) * 0.1593017578125f);
        _1873 = exp2(log2(mad(_55, _1853, mad(_54, _1852, (_1851 * _53))) * 9.999999747378752e-05f) * 0.1593017578125f);
        _1874 = exp2(log2(mad(_58, _1853, mad(_57, _1852, (_1851 * _56))) * 9.999999747378752e-05f) * 0.1593017578125f);
        ...
        if ((uint)((uint)((int)(cb0_044w) + (uint)(-5))) < (uint)2) {
          _1940 = cb0_012z * _1085;
          _1941 = cb0_012z * _1086;
          _1942 = cb0_012z * _1087;
          _1945 = mad((WorkingColorSpace_256[0].z), _1942, mad((WorkingColorSpace_256[0].y), _1941, ((WorkingColorSpace_256[0].x) * _1940)));
          _1948 = mad((WorkingColorSpace_256[1].z), _1942, mad((WorkingColorSpace_256[1].y), _1941, ((WorkingColorSpace_256[1].x) * _1940)));
          _1951 = mad((WorkingColorSpace_256[2].z), _1942, mad((WorkingColorSpace_256[2].y), _1941, ((WorkingColorSpace_256[2].x) * _1940)));
          _1954 = mad(-0.21492856740951538f, _1951, mad(-0.2365107536315918f, _1948, (_1945 * 1.4514392614364624f)));
          _1957 = mad(-0.09967592358589172f, _1951, mad(1.17622971534729f, _1948, (_1945 * -0.07655377686023712f)));
          _1960 = mad(0.9977163076400757f, _1951, mad(-0.006032449658960104f, _1948, (_1945 * 0.008316148072481155f)));
          _1962 = max(_1954, max(_1957, _1960));
          if (!(_1962 < 1.000000013351432e-10f)) {
            if (!(((bool)((bool)(_1945 < 0.0f) || (bool)(_1948 < 0.0f))) || (bool)(_1951 < 0.0f))) {
              _1972 = abs(_1962);
              _1973 = (_1962 - _1954) / _1972;
              _1975 = (_1962 - _1957) / _1972;
              _1977 = (_1962 - _1960) / _1972;
              if (!(_1973 < 0.8149999976158142f)) {
                _1980 = _1973 + -0.8149999976158142f;
              ...
              if (!(_1975 < 0.8029999732971191f)) {
                _1995 = _1975 + -0.8029999732971191f;
              ...
              if (!(_1977 < 0.8799999952316284f)) {
                _2010 = _1977 + -0.8799999952316284f;
          ...
          _2048 = ((mad(0.16386906802654266f, _2032, mad(0.14067870378494263f, _2031, (_2030 * 0.6954522132873535f))) - _1945) * cb0_012w) + _1945;
          _2049 = ((mad(0.0955343171954155f, _2032, mad(0.8596711158752441f, _2031, (_2030 * 0.044794563204050064f))) - _1948) * cb0_012w) + _1948;
          _2050 = ((mad(1.0015007257461548f, _2032, mad(0.004025210160762072f, _2031, (_2030 * -0.005525882821530104f))) - _1951) * cb0_012w) + _1951;
          _2054 = max(max(_2048, _2049), _2050);
          _2059 = (max(_2054, 1.000000013351432e-10f) - max(min(min(_2048, _2049), _2050), 1.000000013351432e-10f)) / max(_2054, 0.009999999776482582f);
          _2072 = ((_2049 + _2048) + _2050) + (sqrt((((_2050 - _2049) * _2050) + ((_2049 - _2048) * _2049)) + ((_2048 - _2050) * _2048)) * 1.75f);
          _2073 = _2072 * 0.3333333432674408f;
          _2074 = _2059 + -0.4000000059604645f;
          _2075 = _2074 * 5.0f;
          _2079 = max((1.0f - abs(_2074 * 2.5f)), 0.0f);
          _2090 = ((float((int)(((int)(uint)((bool)(_2075 > 0.0f))) - ((int)(uint)((bool)(_2075 < 0.0f))))) * (1.0f - (_2079 * _2079))) + 1.0f) * 0.02500000037252903f;
          ...
          if (!((bool)(_2101 == _2102) && (bool)(_2102 == _2103))) {
            _2110 = ((_2101 * 2.0f) - _2102) - _2103;
            _2113 = ((_2049 - _2050) * 1.7320507764816284f) * _2100;
            _2115 = atan(_2113 / _2110);
            _2118 = (_2110 < 0.0f);
            _2119 = (_2110 == 0.0f);
            _2120 = (_2113 >= 0.0f);
            _2121 = (_2113 < 0.0f);
          ...
          _2137 = min(max(select((_2132 < 0.0f), (_2132 + 360.0f), _2132), 0.0f), 360.0f);
          if (_2137 < -180.0f) {
            _2146 = (_2137 + 360.0f);
          } else {
            if (_2137 > 180.0f) {
          ...
          if ((bool)(_2146 > -67.5f) && (bool)(_2146 < 67.5f)) {
            _2152 = (_2146 + 67.5f) * 0.029629629105329514f;
            _2153 = int(_2152);
            _2155 = _2152 - float((int)(_2153));
            _2156 = _2155 * _2155;
            _2157 = _2156 * _2155;
            if (_2153 == 3) {
          ...
          _2194 = min(max(((((_2059 * 0.27000001072883606f) * (0.029999999329447746f - _2101)) * _2185) + _2101), 0.0f), 65535.0f);
          _2195 = min(max(_2102, 0.0f), 65535.0f);
          _2196 = min(max(_2103, 0.0f), 65535.0f);
          _2209 = min(max(mad(-0.21492856740951538f, _2196, mad(-0.2365107536315918f, _2195, (_2194 * 1.4514392614364624f))), 0.0f), 65504.0f);
          _2210 = min(max(mad(-0.09967592358589172f, _2196, mad(1.17622971534729f, _2195, (_2194 * -0.07655377686023712f))), 0.0f), 65504.0f);
          _2211 = min(max(mad(0.9977163076400757f, _2196, mad(-0.006032449658960104f, _2195, (_2194 * 0.008316148072481155f))), 0.0f), 65504.0f);
          _2212 = dot(float3(_2209, _2210, _2211), float3(0.2722287178039551f, 0.6740817427635193f, 0.053689517080783844f));
          _14[0] = cb0_010x;
          _14[1] = cb0_010y;
          _14[2] = cb0_010z;
          _14[3] = cb0_010w;
          ...
          _15[4] = cb0_012y;
          _15[5] = cb0_012y;
          _2235 = log2(max((lerp(_2212, _2209, 0.9599999785423279f)), 1.000000013351432e-10f));
          _2236 = _2235 * 0.3010300099849701f;
          _2237 = log2(cb0_008x);
          _2238 = _2237 * 0.3010300099849701f;
          if (_2236 > _2238) {
            _2245 = log2(cb0_009x);
            _2246 = _2245 * 0.3010300099849701f;
            if ((bool)(_2236 > _2238) && (bool)(_2236 < _2246)) {
              _2254 = ((_2235 - _2237) * 0.9030900001525879f) / ((_2245 - _2237) * 0.3010300099849701f);
              _2255 = int(_2254);
              _2257 = _2254 - float((int)(_2255));
              _2259 = _14[_2255];
              _2262 = _14[(_2255 + 1)];
              _2267 = _2259 * 0.5f;
              ...
              if ((_2236 < _2246) || ((!(_2236 < _2246)) && (!(_2236 < ((log2(cb0_008z)) * 0.3010300099849701f))))) {
                _2307 = (log2(cb0_008w) * 0.3010300099849701f);
              } else {
                _2284 = ((_2235 - _2245) * 0.9030900001525879f) / ((_2276 - _2245) * 0.3010300099849701f);
                _2285 = int(_2284);
                _2287 = _2284 - float((int)(_2285));
                _2289 = _15[_2285];
                _2292 = _15[(_2285 + 1)];
                _2297 = _2289 * 0.5f;
          ...
          _11[4] = cb0_012y;
          _11[5] = cb0_012y;
          _2323 = log2(max((lerp(_2212, _2210, 0.9599999785423279f)), 1.000000013351432e-10f));
          _2324 = _2323 * 0.3010300099849701f;
          if (_2324 > _2238) {
            _2331 = log2(cb0_009x);
            _2332 = _2331 * 0.3010300099849701f;
            if ((bool)(_2324 > _2238) && (bool)(_2324 < _2332)) {
              _2340 = ((_2323 - _2237) * 0.9030900001525879f) / ((_2331 - _2237) * 0.3010300099849701f);
              _2341 = int(_2340);
              _2343 = _2340 - float((int)(_2341));
              _2345 = _10[_2341];
              _2348 = _10[(_2341 + 1)];
              _2353 = _2345 * 0.5f;
              ...
              if ((_2324 < _2332) || ((!(_2324 < _2332)) && (!(_2324 < ((log2(cb0_008z)) * 0.3010300099849701f))))) {
                _2393 = (log2(cb0_008w) * 0.3010300099849701f);
              } else {
                _2370 = ((_2323 - _2331) * 0.9030900001525879f) / ((_2362 - _2331) * 0.3010300099849701f);
                _2371 = int(_2370);
                _2373 = _2370 - float((int)(_2371));
                _2375 = _11[_2371];
                _2378 = _11[(_2371 + 1)];
                _2383 = _2375 * 0.5f;
          ...
          _13[4] = cb0_012y;
          _13[5] = cb0_012y;
          _2409 = log2(max((lerp(_2212, _2211, 0.9599999785423279f)), 1.000000013351432e-10f));
          _2410 = _2409 * 0.3010300099849701f;
          if (_2410 > _2238) {
            _2417 = log2(cb0_009x);
            _2418 = _2417 * 0.3010300099849701f;
            if ((bool)(_2410 > _2238) && (bool)(_2410 < _2418)) {
              _2426 = ((_2409 - _2237) * 0.9030900001525879f) / ((_2417 - _2237) * 0.3010300099849701f);
              _2427 = int(_2426);
              _2429 = _2426 - float((int)(_2427));
              _2431 = _12[_2427];
              _2434 = _12[(_2427 + 1)];
              _2439 = _2431 * 0.5f;
              ...
              if ((_2410 < _2418) || ((!(_2410 < _2418)) && (!(_2410 < ((log2(cb0_008z)) * 0.3010300099849701f))))) {
                _2479 = (log2(cb0_008w) * 0.3010300099849701f);
              } else {
                _2456 = ((_2409 - _2417) * 0.9030900001525879f) / ((_2448 - _2417) * 0.3010300099849701f);
                _2457 = int(_2456);
                _2459 = _2456 - float((int)(_2457));
                _2461 = _13[_2457];
                _2464 = _13[(_2457 + 1)];
                _2469 = _2461 * 0.5f;
          ...
          _2483 = cb0_008w - cb0_008y;
          _2484 = (exp2(_2307 * 3.321928024291992f) - cb0_008y) / _2483;
          _2486 = (exp2(_2393 * 3.321928024291992f) - cb0_008y) / _2483;
          _2488 = (exp2(_2479 * 3.321928024291992f) - cb0_008y) / _2483;
          _2491 = mad(0.15618768334388733f, _2488, mad(0.13400420546531677f, _2486, (_2484 * 0.6624541878700256f)));
          _2494 = mad(0.053689517080783844f, _2488, mad(0.6740817427635193f, _2486, (_2484 * 0.2722287178039551f)));
          _2497 = mad(1.0103391408920288f, _2488, mad(0.00406073359772563f, _2486, (_2484 * -0.005574649665504694f)));
          _2510 = min(max(mad(-0.23642469942569733f, _2497, mad(-0.32480329275131226f, _2494, (_2491 * 1.6410233974456787f))), 0.0f), 1.0f);
          _2511 = min(max(mad(0.016756348311901093f, _2497, mad(1.6153316497802734f, _2494, (_2491 * -0.663662850856781f))), 0.0f), 1.0f);
          _2512 = min(max(mad(0.9883948564529419f, _2497, mad(-0.008284442126750946f, _2494, (_2491 * 0.011721894145011902f))), 0.0f), 1.0f);
          _2515 = mad(0.15618768334388733f, _2512, mad(0.13400420546531677f, _2511, (_2510 * 0.6624541878700256f)));
          _2518 = mad(0.053689517080783844f, _2512, mad(0.6740817427635193f, _2511, (_2510 * 0.2722287178039551f)));
          _2521 = mad(1.0103391408920288f, _2512, mad(0.00406073359772563f, _2511, (_2510 * -0.005574649665504694f)));
          _2543 = min(max((min(max(mad(-0.23642469942569733f, _2521, mad(-0.32480329275131226f, _2518, (_2515 * 1.6410233974456787f))), 0.0f), 65535.0f) * cb0_008w), 0.0f), 65535.0f);
          _2546 = min(max((min(max(mad(0.016756348311901093f, _2521, mad(1.6153316497802734f, _2518, (_2515 * -0.663662850856781f))), 0.0f), 65535.0f) * cb0_008w), 0.0f), 65535.0f) * 0.012500000186264515f;
          _2547 = min(max((min(max(mad(0.9883948564529419f, _2521, mad(-0.008284442126750946f, _2518, (_2515 * 0.011721894145011902f))), 0.0f), 65535.0f) * cb0_008w), 0.0f), 65535.0f) * 0.012500000186264515f;
          ...
          if (cb0_044w == 7) {
            _2566 = mad((WorkingColorSpace_128[0].z), _1087, mad((WorkingColorSpace_128[0].y), _1086, ((WorkingColorSpace_128[0].x) * _1085)));
            _2569 = mad((WorkingColorSpace_128[1].z), _1087, mad((WorkingColorSpace_128[1].y), _1086, ((WorkingColorSpace_128[1].x) * _1085)));
            _2572 = mad((WorkingColorSpace_128[2].z), _1087, mad((WorkingColorSpace_128[2].y), _1086, ((WorkingColorSpace_128[2].x) * _1085)));
            _2591 = exp2(log2(mad(_52, _2572, mad(_51, _2569, (_2566 * _50))) * 9.999999747378752e-05f) * 0.1593017578125f);
            _2592 = exp2(log2(mad(_55, _2572, mad(_54, _2569, (_2566 * _53))) * 9.999999747378752e-05f) * 0.1593017578125f);
            _2593 = exp2(log2(mad(_58, _2572, mad(_57, _2569, (_2566 * _56))) * 9.999999747378752e-05f) * 0.1593017578125f);
            ...
            if (!(cb0_044w == 8)) {
              if (cb0_044w == 9) {
                _2632 = mad((WorkingColorSpace_128[0].z), _1075, mad((WorkingColorSpace_128[0].y), _1074, ((WorkingColorSpace_128[0].x) * _1073)));
                _2635 = mad((WorkingColorSpace_128[1].z), _1075, mad((WorkingColorSpace_128[1].y), _1074, ((WorkingColorSpace_128[1].x) * _1073)));
                _2638 = mad((WorkingColorSpace_128[2].z), _1075, mad((WorkingColorSpace_128[2].y), _1074, ((WorkingColorSpace_128[2].x) * _1073)));
                ...
                _2651 = mad((WorkingColorSpace_128[0].z), _1101, mad((WorkingColorSpace_128[0].y), _1100, ((WorkingColorSpace_128[0].x) * _1099)));
                _2654 = mad((WorkingColorSpace_128[1].z), _1101, mad((WorkingColorSpace_128[1].y), _1100, ((WorkingColorSpace_128[1].x) * _1099)));
                _2657 = mad((WorkingColorSpace_128[2].z), _1101, mad((WorkingColorSpace_128[2].y), _1100, ((WorkingColorSpace_128[2].x) * _1099)));
