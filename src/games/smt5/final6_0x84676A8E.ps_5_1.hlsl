// ---- Created with 3Dmigoto v1.3.16 on Mon Sep 30 22:32:49 2024
// Final 6, Shinjuku
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.x = -r0.w * r0.x + 1;
  r0.w = (int)r0.y & 192;
  if (1 == 0) r0.y = 0; else if (1+7 < 32) {   r0.y = (uint)r0.y << (32-(1 + 7)); r0.y = (uint)r0.y >> (32-1);  } else r0.y = (uint)r0.y >> 7;
  ...
  r1.yzw = r1.xxx * -cb2[5].xyz + cb2[5].xyz;
  r2.xy = saturate(cb4[5].yz + r0.zz);
  r0.z = saturate(cb4[6].x + r0.z);
  r1.yzw = -r2.xxx * r1.yzw + float3(1,1,1);
  r0.xyw = -r0.xyw * r1.yzw + float3(1,1,1);
  r1.yzw = float3(1,1,1) + -r0.xyw;
  r1.yzw = r1.yzw + r1.yzw;
  r2.y = cb4[5].w * r2.y;
  r0.z = r0.z * cb4[6].y + -r2.y;
  r2.z = saturate(cb1[18].z);
  r0.z = saturate(r2.z * r0.z + r2.y);
  r0.z = cb3[1].x * r0.z;
  r2.yzw = float3(-0.5,-0.5,-0.5) + cb2[6].xyz;
  r2.yzw = r2.yzw * r1.xxx;
  r2.xyz = r2.xxx * r2.yzw + float3(0.5,0.5,0.5);
  r3.xyz = cb2[7].xyz + -r2.xyz;
  r2.xyz = r0.zzz * r3.xyz + r2.xyz;
  r3.xyz = float3(1,1,1) + -r2.xyz;
  r2.xyz = r2.xyz * r0.xyw;
  r0.xyz = cmp(r0.xyw >= float3(0.5,0.5,0.5));
  r2.xyz = r2.xyz + r2.xyz;
  r1.xyz = -r1.yzw * r3.xyz + float3(1,1,1);
