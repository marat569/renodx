// Found in Lies of P (UE 4.27)

#include "../lutbuilderoutput.hlsli"

// ---- Created with 3Dmigoto v1.3.16 on Sat Jun  7 23:50:43 2025
...
void main(uint3 vThreadID: SV_DispatchThreadID) {
  const float4 icb[] = { { -4.000000, -0.332863, -0.448966, 0 },
                         { -4.000000, 1.695346, 1.811449, 0 },
                         { -3.157377, 2.758124, 3.031154, 0 },
                         { -0.485250, 3.000000, 3.301030, 0 },
                         { 1.847732, 3.000000, 3.301030, 0 },
                         { 1.847732, 3.000000, 3.301030, 0 } };
  ...
  u0[vThreadID.xyz] = ProcessLutbuilder(float3(untonemapped_ap1), s0_s, t0, cb_config, u0[vThreadID.xyz], asuint(cb0[65].z));
  return;
  ...
  r1.w = r2.y + r1.w;
  r2.x = 0.0625 * r1.w;
  r3.xyz = t0.SampleLevel(s0_s, r2.xz, 0).xyz;
  ...
  if (asuint(cb0[65].z) == 0) {
    ...
    if (r0.w != 0) {
      ...
      if (r0.w != 0) {
        ...
        r7.xyz = log2(r7.xyz);
        r8.xyz = cmp(float3(-18.6044617, -18.6044617, -18.6044617) >= r7.xyz);
        if (r8.x != 0) {
          r0.w = -4;
        } else {
          r1.w = cmp(r7.x < -3.6044631);
          if (r1.w != 0) {
            r1.w = r7.x * 0.30103001 + 5.60050106;
            r2.w = 0.664385676 * r1.w;
            r3.w = (int)r2.w;
            r2.w = trunc(r2.w);
            r9.y = r1.w * 0.664385676 + -r2.w;
            ...
            r1.w = cmp(r7.x < 9.43598557);
            if (r1.w != 0) {
              r1.w = r7.x * 0.30103001 + 1.08505154;
              r2.w = 0.764220953 * r1.w;
              r3.w = (int)r2.w;
              r2.w = trunc(r2.w);
              r9.y = r1.w * 0.764220953 + -r2.w;
        ...
        if (r8.y != 0) {
          ...
          r2.w = cmp(r7.y < -3.6044631);
          if (r2.w != 0) {
            r2.w = r7.y * 0.30103001 + 5.60050106;
            r3.w = 0.664385676 * r2.w;
            r4.w = (int)r3.w;
            r3.w = trunc(r3.w);
            r9.y = r2.w * 0.664385676 + -r3.w;
            ...
            r2.w = cmp(r7.y < 9.43598557);
            if (r2.w != 0) {
              r2.w = r7.y * 0.30103001 + 1.08505154;
              r3.w = 0.764220953 * r2.w;
              r4.w = (int)r3.w;
              r3.w = trunc(r3.w);
              r9.y = r2.w * 0.764220953 + -r3.w;
        ...
        if (r8.z != 0) {
          ...
          r3.w = cmp(r7.z < -3.6044631);
          if (r3.w != 0) {
            r3.w = r7.z * 0.30103001 + 5.60050106;
            r4.w = 0.664385676 * r3.w;
            r5.w = (int)r4.w;
            r4.w = trunc(r4.w);
            r8.y = r3.w * 0.664385676 + -r4.w;
            ...
            r3.w = cmp(r7.z < 9.43598557);
            if (r3.w != 0) {
              r3.w = r7.z * 0.30103001 + 1.08505154;
              r4.w = 0.764220953 * r3.w;
              r5.w = (int)r4.w;
              r4.w = trunc(r4.w);
              r7.y = r3.w * 0.764220953 + -r4.w;
        ...
        r7.x = 0.00100000016 * r0.w;
        r0.w = -9.99999975e-05 + r1.w;
        r7.y = 0.00100000016 * r0.w;
        r0.w = -9.99999975e-05 + r2.w;
        r7.z = 0.00100000016 * r0.w;
        ...
        r7.xyz = float3(1000, 1000, 1000) * r7.xyz;
        r0.w = cmp(asint(cb0[65].z) != 5);
        r8.x = dot(r5.xyz, r7.xyz);
        r8.y = dot(r6.xyz, r7.xyz);
        r8.z = dot(r4.xyz, r7.xyz);
        ...
        if (r0.w != 0) {
          ...
          r7.xyz = max(float3(1.00000001e-10, 1.00000001e-10, 1.00000001e-10), r7.xyz);
          r7.xyz = log2(r7.xyz);
          r8.xyz = cmp(float3(-18.5941086, -18.5941086, -18.5941086) >= r7.xyz);
          if (r8.x != 0) {
            r0.w = -4;
          } else {
            r1.w = cmp(r7.x < -3.59411001);
            if (r1.w != 0) {
              r1.w = r7.x * 0.30103001 + 5.59738445;
              r2.w = 0.664385676 * r1.w;
              r3.w = (int)r2.w;
              r2.w = trunc(r2.w);
              r9.y = r1.w * 0.664385676 + -r2.w;
              ...
              r1.w = cmp(r7.x < 10.939312);
              if (r1.w != 0) {
                r1.w = r7.x * 0.30103001 + 1.08193493;
                r2.w = 0.685714841 * r1.w;
                r3.w = (int)r2.w;
                r2.w = trunc(r2.w);
                r9.y = r1.w * 0.685714841 + -r2.w;
                r7.xw = (int2)r3.ww + int2(1, 2);
                r9.x = r9.y * r9.y;
                r10.x = icb[r3.w + 0].z;
                r10.y = icb[r7.x + 0].z;
          ...
          if (r8.y != 0) {
            ...
            r2.w = cmp(r7.y < -3.59411001);
            if (r2.w != 0) {
              r2.w = r7.y * 0.30103001 + 5.59738445;
              r3.w = 0.664385676 * r2.w;
              r4.w = (int)r3.w;
              r3.w = trunc(r3.w);
              r9.y = r2.w * 0.664385676 + -r3.w;
              ...
              r2.w = cmp(r7.y < 10.939312);
              if (r2.w != 0) {
                r2.w = r7.y * 0.30103001 + 1.08193493;
                r3.w = 0.685714841 * r2.w;
                r4.w = (int)r3.w;
                r3.w = trunc(r3.w);
                r9.y = r2.w * 0.685714841 + -r3.w;
                r7.xy = (int2)r4.ww + int2(1, 2);
                r9.x = r9.y * r9.y;
                r10.x = icb[r4.w + 0].z;
                r10.y = icb[r7.x + 0].z;
          ...
          if (r8.z != 0) {
            ...
            r3.w = cmp(r7.z < -3.59411001);
            if (r3.w != 0) {
              r3.w = r7.z * 0.30103001 + 5.59738445;
              r4.w = 0.664385676 * r3.w;
              r5.w = (int)r4.w;
              r4.w = trunc(r4.w);
              r8.y = r3.w * 0.664385676 + -r4.w;
              ...
              r3.w = cmp(r7.z < 10.939312);
              if (r3.w != 0) {
                r3.w = r7.z * 0.30103001 + 1.08193493;
                r4.w = 0.685714841 * r3.w;
                r5.w = (int)r4.w;
                r4.w = trunc(r4.w);
                r7.y = r3.w * 0.685714841 + -r4.w;
                r8.xy = (int2)r5.ww + int2(1, 2);
                r7.x = r7.y * r7.y;
                r9.x = icb[r5.w + 0].z;
                r9.y = icb[r8.x + 0].z;
          ...
          r2.w = exp2(r2.w);
          r0.w = -9.99999975e-05 + r0.w;
          r7.x = 0.000500000024 * r0.w;
          r0.w = -9.99999975e-05 + r1.w;
          r7.y = 0.000500000024 * r0.w;
          r0.w = -9.99999975e-05 + r2.w;
          r7.z = 0.000500000024 * r0.w;
          r8.x = dot(float3(0.662454188, 0.134004205, 0.156187683), r7.xyz);
          r8.y = dot(float3(0.272228718, 0.674081743, 0.0536895171), r7.xyz);
          r8.z = dot(float3(-0.00557464967, 0.0040607336, 1.01033914), r7.xyz);
          r7.x = saturate(dot(float3(1.6410234, -0.324803293, -0.236424699), r8.xyz));
          ...
          r7.z = dot(float3(0.0117218941, -0.00828444213, 0.988394856), r8.xyz);
          r7.xyz = max(float3(0, 0, 0), r7.xyz);
          r7.xyz = float3(2000, 2000, 2000) * r7.xyz;
          r0.w = cmp(asint(cb0[65].z) != 6);
          r8.x = dot(r5.xyz, r7.xyz);
          r8.y = dot(r6.xyz, r7.xyz);
          r8.z = dot(r4.xyz, r7.xyz);
          r7.xyz = r0.www ? r8.xyz : r7.xyz;
