  ...
  if (OutputDevice == 0) {
    ...
    if (OutputDevice == 1) {
      ...
      if ((bool)(OutputDevice == 3) || (bool)(OutputDevice == 5)) {
        ...
        float _1218 = ((float((int)(((int)(uint)((bool)(_1203 > 0.0f))) - ((int)(uint)((bool)(_1203 < 0.0f))))) * (1.0f - (_1207 * _1207))) + 1.0f) * 0.02500000037252903f;
        do {
            ...
            do {
              ...
              do {
                if ((bool)(_1274 > -67.5f) && (bool)(_1274 < 67.5f)) {
                  ...
                  int _1281 = int(_1280);
                  float _1283 = _1280 - float((int)(_1281));
                      ...
                      do {
                        if (!(!(_1352 >= _1362))) {
                          ...
                          if (_1352 < (_1392 * 0.3010300099849701f)) {
                            ...
                            int _1401 = int(_1400);
                            float _1403 = _1400 - float((int)(_1401));
                  ...
                  do {
                    if (!(!(_1428 <= _1354))) {
                      ...
                      if ((bool)(_1428 > _1354) && (bool)(_1428 < _1436)) {
                        ...
                        int _1445 = int(_1444);
                        float _1447 = _1444 - float((int)(_1445));
                    ...
                    do {
                      if (!(!(_1502 <= _1354))) {
                        ...
                        if ((bool)(_1502 > _1354) && (bool)(_1502 < _1510)) {
                          ...
                          int _1519 = int(_1518);
                          float _1521 = _1518 - float((int)(_1519));
        ...
        if ((OutputDevice & -3) == 4) {
          ...
          float _1792 = ((float((int)(((int)(uint)((bool)(_1777 > 0.0f))) - ((int)(uint)((bool)(_1777 < 0.0f))))) * (1.0f - (_1781 * _1781))) + 1.0f) * 0.02500000037252903f;
          do {
                  ...
                  do {
                    if (!(!(_1926 <= _1928))) {
                      ...
                      if ((bool)(_1926 > _1928) && (bool)(_1926 < _1936)) {
                        ...
                        int _1945 = int(_1944);
                        float _1947 = _1944 - float((int)(_1945));
                        ...
                        do {
                          if (!(!(_1926 >= _1936))) {
                            ...
                            if (_1926 < (_1966 * 0.3010300099849701f)) {
                              ...
                              int _1975 = int(_1974);
                              float _1977 = _1974 - float((int)(_1975));
                    ...
                    do {
                      if (!(!(_2002 <= _1928))) {
                        ...
                        if ((bool)(_2002 > _1928) && (bool)(_2002 < _2010)) {
                          ...
                          int _2019 = int(_2018);
                          float _2021 = _2018 - float((int)(_2019));
                          ...
                          do {
                            if (!(!(_2002 >= _2010))) {
                              ...
                              if (_2002 < (_2040 * 0.3010300099849701f)) {
                                ...
                                int _2049 = int(_2048);
                                float _2051 = _2048 - float((int)(_2049));
                      ...
                      do {
                        if (!(!(_2076 <= _1928))) {
                          ...
                          if ((bool)(_2076 > _1928) && (bool)(_2076 < _2084)) {
                            ...
                            int _2093 = int(_2092);
                            float _2095 = _2092 - float((int)(_2093));
