...
void main(
  ...
  float _754 = select((_694 < _685), ((_703 / (exp2((_706 * 1.4426950216293335f) * _705) + 1.0f)) - cb0_038x), _700);
  float _755 = select((_695 < _685), ((_703 / (exp2((_707 * 1.4426950216293335f) * _705) + 1.0f)) - cb0_038x), _701);
  float _756 = select((_696 < _685), ((_703 / (exp2((_708 * 1.4426950216293335f) * _705) + 1.0f)) - cb0_038x), _702);
  ...
  float _818 = (cb0_037x * (max(0.0f, (lerp(_798, _795, 0.9300000071525574f))) - _514)) + _514;
  float _819 = (cb0_037x * (max(0.0f, (lerp(_798, _796, 0.9300000071525574f))) - _515)) + _515;
  float _820 = (cb0_037x * (max(0.0f, (lerp(_798, _797, 0.9300000071525574f))) - _516)) + _516;
  ...
  float _860 = max(0.0f, mad((WorkingColorSpace_192[0].z), _838, mad((WorkingColorSpace_192[0].y), _837, ((WorkingColorSpace_192[0].x) * _836))));
  float _861 = max(0.0f, mad((WorkingColorSpace_192[1].z), _838, mad((WorkingColorSpace_192[1].y), _837, ((WorkingColorSpace_192[1].x) * _836))));
  float _862 = max(0.0f, mad((WorkingColorSpace_192[2].z), _838, mad((WorkingColorSpace_192[2].y), _837, ((WorkingColorSpace_192[2].x) * _836))));
  ...
  float _911 = exp2(log2(max(0.0f, (lerp(_888, cb0_013x, cb0_013w)))) * cb0_040y);
  float _912 = exp2(log2(max(0.0f, (lerp(_889, cb0_013y, cb0_013w)))) * cb0_040y);
  float _913 = exp2(log2(max(0.0f, (lerp(_890, cb0_013z, cb0_013w)))) * cb0_040y);
