...
extern "C" __declspec(dllexport) const char* NAME = "RenoDX for RuneScape: Dragonwilds";
extern "C" __declspec(dllexport) const char* DESCRIPTION = "RenoDX for RuneScape: Dragonwilds";
