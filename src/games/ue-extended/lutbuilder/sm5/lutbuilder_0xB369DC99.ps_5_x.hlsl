...
void main(
  ...
  float3 untonemapped_ap1 = r4.xyz;
  ...
  float4 lutweights[2] = { float4(asfloat(cb0[34].x), asfloat(cb0[35].x), asfloat(cb0[36].x), 0.f), float4(0.f, 0.f, 0.f, 0.f) };
  cb_config.ue_lutweights = lutweights;  // Only Lutweights[0].xy is used

  o0 = ProcessLutbuilder(float3(untonemapped_ap1), s0_s, s1_s, t0, t1, cb_config, o0, asuint(cb0[31].w));
  ...
  r2.xyz = cb0[35].xxx * r2.xyz;
  r0.xyz = cb0[34].xxx * r0.xyz + r2.xyz;
  r2.xyz = t1.Sample(s1_s, r1.xz).xyz;
  r1.xyz = t1.Sample(s1_s, r1.yw).xyz;
  r1.xyz = r1.xyz + -r2.xyz;
  r1.xyz = r0.www * r1.xyz + r2.xyz;
  r0.xyz = cb0[36].xxx * r1.xyz + r0.xyz;
