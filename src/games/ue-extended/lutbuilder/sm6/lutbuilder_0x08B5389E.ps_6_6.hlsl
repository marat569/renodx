// Code Vein 2/ Generic UE 5.4

#define USE_SDR_LUT     0
#define LUTBUILDER_HASH 0x08B5389E
...
float4 main(
  ...
  float _404 = (1.0f - exp2(((_386 * _386) * -4.0f) * 0.f)) * (1.0f - exp2(dot(float3(_390, _391, _392), float3(_390, _391, _392)) * -4.0f));
  ...
  // if (GenerateOutput(_1198, _1199, _1200, SV_Target, OutputDevice)) {
  //   return SV_Target;
  // }
    ...
    if (OutputDevice == 1) {
      ...
      if ((bool)(OutputDevice == 3) || (bool)(OutputDevice == 5)) {
        ...
        do {
          ...
          float _1561 = ((float((int)(((int)(uint)((bool)(_1546 > 0.0f))) - ((int)(uint)((bool)(_1546 < 0.0f))))) * (1.0f - (_1550 * _1550))) + 1.0f) * 0.02500000037252903f;
          do {
              ...
              do {
                ...
                do {
                  if ((bool)(_1617 > -67.5f) && (bool)(_1617 < 67.5f)) {
                    ...
                    int _1624 = int(_1623);
                    float _1626 = _1623 - float((int)(_1624));
                    ...
                    do {
                      if (!(!(_1771 <= _1697))) {
                        ...
                        if ((bool)(_1771 > _1697) && (bool)(_1771 < _1779)) {
                          ...
                          int _1788 = int(_1787);
                          float _1790 = _1787 - float((int)(_1788));
                          ...
                          do {
                            if (!(!(_1771 >= _1779))) {
                              ...
                              if (_1771 < (_1809 * 0.3010300099849701f)) {
                                ...
                                int _1818 = int(_1817);
                                float _1820 = _1817 - float((int)(_1818));
                      ...
                      do {
                        if (!(!(_1845 <= _1697))) {
                          ...
                          if ((bool)(_1845 > _1697) && (bool)(_1845 < _1853)) {
                            ...
                            int _1862 = int(_1861);
                            float _1864 = _1861 - float((int)(_1862));
                            ...
                            do {
                              if (!(!(_1845 >= _1853))) {
                                ...
                                if (_1845 < (_1883 * 0.3010300099849701f)) {
                                  ...
                                  int _1892 = int(_1891);
                                  float _1894 = _1891 - float((int)(_1892));
        ...
        if ((OutputDevice & -3) == 4) {
          ...
          do {
            ...
            float _2235 = ((float((int)(((int)(uint)((bool)(_2220 > 0.0f))) - ((int)(uint)((bool)(_2220 < 0.0f))))) * (1.0f - (_2224 * _2224))) + 1.0f) * 0.02500000037252903f;
            do {
                ...
                do {
                  ...
                  do {
                    if ((bool)(_2291 > -67.5f) && (bool)(_2291 < 67.5f)) {
                      ...
                      int _2298 = int(_2297);
                      float _2300 = _2297 - float((int)(_2298));
                    ...
                    do {
                      if (!(!(_2369 <= _2371))) {
                        ...
                        if ((bool)(_2369 > _2371) && (bool)(_2369 < _2379)) {
                          ...
                          int _2388 = int(_2387);
                          float _2390 = _2387 - float((int)(_2388));
