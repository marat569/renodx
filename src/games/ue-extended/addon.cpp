...
renodx::utils::settings::Settings settings = {
    ...
    new renodx::utils::settings::Setting{
        ...
        .label = std::string("\nPlease read the install instructions, or else the mod will not work!\n\n"),
        .section = "Instructions",
    },
    new renodx::utils::settings::Setting{
        .value_type = renodx::utils::settings::SettingValueType::BUTTON,
        .label = "Installation Instructions (CLICK ME)",
        .section = "Instructions",
        .group = "button-line-2",
        .tint = 0x5865F2,
        .on_change = []() {
          renodx::utils::platform::LaunchURL("https://github.com/clshortfuse/renodx/discussions/494");
        },
    },
    new renodx::utils::settings::Setting{
        .key = "ToneMapType",
...
extern "C" __declspec(dllexport) constexpr const char* DESCRIPTION = "RenoDX for Unreal Engine (Extended)";
