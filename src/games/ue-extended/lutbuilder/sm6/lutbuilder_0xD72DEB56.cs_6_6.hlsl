...
void main(
  ...
  bool _156 = (cb0_038w != 0);
  float _160 = 0.9994439482688904f / cb0_035y;
  ...
  float _191 = ((((cb0_035y * 1.2864121856637212e-07f) + 0.00015411825734190643f) * cb0_035y) + 0.8601177334785461f) / ((((cb0_035y * 7.081451371959702e-07f) + 0.0008424202096648514f) * cb0_035y) + 1.0f);
  float _198 = cb0_035y * cb0_035y;
  float _201 = ((((cb0_035y * 4.204816761443908e-08f) + 4.228062607580796e-05f) * cb0_035y) + 0.31739872694015503f) / ((1.0f - (cb0_035y * 2.8974181986995973e-05f)) + (_198 * 1.6145605741257896e-07f));
  float _206 = ((_191 * 2.0f) + 4.0f) - (_201 * 8.0f);
  float _207 = (_191 * 3.0f) / _206;
  float _209 = (_201 * 2.0f) / _206;
  bool _210 = (cb0_035y < 4000.0f);
  float _219 = ((cb0_035y + 1189.6199951171875f) * cb0_035y) + 1412139.875f;
  float _221 = ((-1137581184.0f - (cb0_035y * 1916156.25f)) - (_198 * 1.5317699909210205f)) / (_219 * _219);
  float _228 = (6193636.0f - (cb0_035y * 179.45599365234375f)) + _198;
  float _230 = ((1974715392.0f - (cb0_035y * 705674.0f)) - (_198 * 308.60699462890625f)) / (_228 * _228);
  float _232 = rsqrt(dot(float2(_221, _230), float2(_221, _230)));
  float _233 = cb0_035z * 0.05000000074505806f;
  ...
  // float _422 = (1.0f - exp2(((_404 * _404) * -4.0f) * cb0_036w)) * (1.0f - exp2(dot(float3(_408, _409, _410), float3(_408, _409, _410)) * -4.0f));
  float _422 = (1.0f - exp2(((_404 * _404) * -4.0f) * 0.f)) * (1.0f - exp2(dot(float3(_408, _409, _410), float3(_408, _409, _410)) * -4.0f));
  ...
  float _455 = cb0_019w + cb0_024w;
  float _469 = cb0_018w * cb0_023w;
  float _483 = cb0_017w * cb0_022w;
  float _497 = cb0_016w * cb0_021w;
  float _511 = cb0_015w * cb0_020w;
  float _515 = _438 - _441;
  float _516 = _439 - _441;
  float _517 = _440 - _441;
  float _574 = saturate(_441 / cb0_035w);
  float _578 = (_574 * _574) * (3.0f - (_574 * 2.0f));
  float _579 = 1.0f - _578;
  float _588 = cb0_019w + cb0_034w;
  float _597 = cb0_018w * cb0_033w;
  float _606 = cb0_017w * cb0_032w;
  float _615 = cb0_016w * cb0_031w;
  float _624 = cb0_015w * cb0_030w;
  float _687 = saturate((_441 - cb0_036x) / (cb0_036y - cb0_036x));
  float _691 = (_687 * _687) * (3.0f - (_687 * 2.0f));
  float _700 = cb0_019w + cb0_029w;
  float _709 = cb0_018w * cb0_028w;
  float _718 = cb0_017w * cb0_027w;
  float _727 = cb0_016w * cb0_026w;
  float _736 = cb0_015w * cb0_025w;
  float _794 = _578 - _691;
  float _805 = ((_691 * (((cb0_019x + cb0_034x) + _588) + (((cb0_018x * cb0_033x) * _597) * exp2(log2(exp2(((cb0_016x * cb0_031x) * _615) * log2(max(0.0f, ((((cb0_015x * cb0_030x) * _624) * _515) + _441)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((cb0_017x * cb0_032x) * _606)))))) + (_579 * (((cb0_019x + cb0_024x) + _455) + (((cb0_018x * cb0_023x) * _469) * exp2(log2(exp2(((cb0_016x * cb0_021x) * _497) * log2(max(0.0f, ((((cb0_015x * cb0_020x) * _511) * _515) + _441)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((cb0_017x * cb0_022x) * _483))))))) + ((((cb0_019x + cb0_029x) + _700) + (((cb0_018x * cb0_028x) * _709) * exp2(log2(exp2(((cb0_016x * cb0_026x) * _727) * log2(max(0.0f, ((((cb0_015x * cb0_025x) * _736) * _515) + _441)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((cb0_017x * cb0_027x) * _718))))) * _794);
  float _807 = ((_691 * (((cb0_019y + cb0_034y) + _588) + (((cb0_018y * cb0_033y) * _597) * exp2(log2(exp2(((cb0_016y * cb0_031y) * _615) * log2(max(0.0f, ((((cb0_015y * cb0_030y) * _624) * _516) + _441)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((cb0_017y * cb0_032y) * _606)))))) + (_579 * (((cb0_019y + cb0_024y) + _455) + (((cb0_018y * cb0_023y) * _469) * exp2(log2(exp2(((cb0_016y * cb0_021y) * _497) * log2(max(0.0f, ((((cb0_015y * cb0_020y) * _511) * _516) + _441)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((cb0_017y * cb0_022y) * _483))))))) + ((((cb0_019y + cb0_029y) + _700) + (((cb0_018y * cb0_028y) * _709) * exp2(log2(exp2(((cb0_016y * cb0_026y) * _727) * log2(max(0.0f, ((((cb0_015y * cb0_025y) * _736) * _516) + _441)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((cb0_017y * cb0_027y) * _718))))) * _794);
  float _809 = ((_691 * (((cb0_019z + cb0_034z) + _588) + (((cb0_018z * cb0_033z) * _597) * exp2(log2(exp2(((cb0_016z * cb0_031z) * _615) * log2(max(0.0f, ((((cb0_015z * cb0_030z) * _624) * _517) + _441)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((cb0_017z * cb0_032z) * _606)))))) + (_579 * (((cb0_019z + cb0_024z) + _455) + (((cb0_018z * cb0_023z) * _469) * exp2(log2(exp2(((cb0_016z * cb0_021z) * _497) * log2(max(0.0f, ((((cb0_015z * cb0_020z) * _511) * _517) + _441)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((cb0_017z * cb0_022z) * _483))))))) + ((((cb0_019z + cb0_029z) + _700) + (((cb0_018z * cb0_028z) * _709) * exp2(log2(exp2(((cb0_016z * cb0_026z) * _727) * log2(max(0.0f, ((((cb0_015z * cb0_025z) * _736) * _517) + _441)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((cb0_017z * cb0_027z) * _718))))) * _794);
  ...
  float4 output = ProcessLutbuilder(float3(_805, _807, _809), cb_config, u0[int3((uint)(SV_DispatchThreadID.x), (uint)(SV_DispatchThreadID.y), (uint)(SV_DispatchThreadID.z))], 3u);
  u0[int3((uint)(SV_DispatchThreadID.x), (uint)(SV_DispatchThreadID.y), (uint)(SV_DispatchThreadID.z))] = output;
  return;

  float _845 = ((mad(0.061360642313957214f, _809, mad(-4.540197551250458e-09f, _807, (_805 * 0.9386394023895264f))) - _805) * cb0_036z) + _805;
  float _846 = ((mad(0.169205904006958f, _809, mad(0.8307942152023315f, _807, (_805 * 6.775371730327606e-08f))) - _807) * cb0_036z) + _807;
  float _847 = (mad(-2.3283064365386963e-10f, _807, (_805 * -9.313225746154785e-10f)) * cb0_036z) + _809;
  ...
  float _994 = (cb0_038x + 1.0f) - cb0_037z;
  float _996 = cb0_038y + 1.0f;
  float _998 = _996 - cb0_037w;
  if (cb0_037z > 0.800000011920929f) {
    _1016 = (((0.8199999928474426f - cb0_037z) / cb0_037y) + -0.7447274923324585f);
  } else {
    float _1007 = (cb0_038x + 0.18000000715255737f) / _994;
    _1016 = (-0.7447274923324585f - ((log2(_1007 / (2.0f - _1007)) * 0.3465735912322998f) * (_994 / cb0_037y)));
  }
  float _1019 = ((1.0f - cb0_037z) / cb0_037y) - _1016;
  float _1021 = (cb0_037w / cb0_037y) - _1019;
  ...
  float _1031 = cb0_037y * (_1025 + _1019);
  float _1032 = cb0_037y * (_1026 + _1019);
  float _1033 = cb0_037y * (_1027 + _1019);
  float _1034 = _994 * 2.0f;
  float _1036 = (cb0_037y * -2.0f) / _994;
  float _1037 = _1025 - _1016;
  float _1038 = _1026 - _1016;
  float _1039 = _1027 - _1016;
  float _1058 = _998 * 2.0f;
  float _1060 = (cb0_037y * 2.0f) / _998;
  float _1085 = select((_1025 < _1016), ((_1034 / (exp2((_1037 * 1.4426950216293335f) * _1036) + 1.0f)) - cb0_038x), _1031);
  float _1086 = select((_1026 < _1016), ((_1034 / (exp2((_1038 * 1.4426950216293335f) * _1036) + 1.0f)) - cb0_038x), _1032);
  float _1087 = select((_1027 < _1016), ((_1034 / (exp2((_1039 * 1.4426950216293335f) * _1036) + 1.0f)) - cb0_038x), _1033);
  ...
  float _1149 = (cb0_037x * (max(0.0f, (lerp(_1129, _1126, 0.9300000071525574f))) - _845)) + _845;
  float _1150 = (cb0_037x * (max(0.0f, (lerp(_1129, _1127, 0.9300000071525574f))) - _846)) + _846;
  float _1151 = (cb0_037x * (max(0.0f, (lerp(_1129, _1128, 0.9300000071525574f))) - _847)) + _847;
  float _1167 = ((mad(-0.06537103652954102f, _1151, mad(1.451815478503704e-06f, _1150, (_1149 * 1.065374732017517f))) - _1149) * cb0_036z) + _1149;
  float _1168 = ((mad(-0.20366770029067993f, _1151, mad(1.2036634683609009f, _1150, (_1149 * -2.57161445915699e-07f))) - _1150) * cb0_036z) + _1150;
  float _1169 = ((mad(0.9999996423721313f, _1151, mad(2.0954757928848267e-08f, _1150, (_1149 * 1.862645149230957e-08f))) - _1151) * cb0_036z) + _1151;
  float _1179 = max(0.0f, mad((WorkingColorSpace_192[0].z), _1169, mad((WorkingColorSpace_192[0].y), _1168, ((WorkingColorSpace_192[0].x) * _1167))));
  float _1180 = max(0.0f, mad((WorkingColorSpace_192[1].z), _1169, mad((WorkingColorSpace_192[1].y), _1168, ((WorkingColorSpace_192[1].x) * _1167))));
  float _1181 = max(0.0f, mad((WorkingColorSpace_192[2].z), _1169, mad((WorkingColorSpace_192[2].y), _1168, ((WorkingColorSpace_192[2].x) * _1167))));
  float _1207 = cb0_014x * (((cb0_039y + (cb0_039x * _1179)) * _1179) + cb0_039z);
  float _1208 = cb0_014y * (((cb0_039y + (cb0_039x * _1180)) * _1180) + cb0_039z);
  float _1209 = cb0_014z * (((cb0_039y + (cb0_039x * _1181)) * _1181) + cb0_039z);
  ...
  float _1219 = cb0_014x * mad((WorkingColorSpace_192[0].z), _809, mad((WorkingColorSpace_192[0].y), _807, (_805 * (WorkingColorSpace_192[0].x))));
  float _1220 = cb0_014y * mad((WorkingColorSpace_192[1].z), _809, mad((WorkingColorSpace_192[1].y), _807, ((WorkingColorSpace_192[1].x) * _805)));
  float _1221 = cb0_014z * mad((WorkingColorSpace_192[2].z), _809, mad((WorkingColorSpace_192[2].y), _807, ((WorkingColorSpace_192[2].x) * _805)));
  float _1228 = ((cb0_013x - _1219) * cb0_013w) + _1219;
  float _1229 = ((cb0_013y - _1220) * cb0_013w) + _1220;
  float _1230 = ((cb0_013z - _1221) * cb0_013w) + _1221;
  float _1242 = exp2(log2(max(0.0f, _1216)) * cb0_040y);
  float _1243 = exp2(log2(max(0.0f, _1217)) * cb0_040y);
  float _1244 = exp2(log2(max(0.0f, _1218)) * cb0_040y);
  [branch]
  if (cb0_040w == 0) {
    do {
    ...
    if (cb0_040w == 1) {
      ...
      if ((bool)(cb0_040w == 3) || (bool)(cb0_040w == 5)) {
        ...
        _10[4] = cb0_012y;
        _10[5] = cb0_012y;
        float _1429 = cb0_012z * _1228;
        float _1430 = cb0_012z * _1229;
        float _1431 = cb0_012z * _1230;
        ...
        do {
          ...
          float _1537 = ((mad(0.16386906802654266f, _1521, mad(0.14067870378494263f, _1520, (_1519 * 0.6954522132873535f))) - _1434) * cb0_012w) + _1434;
          float _1538 = ((mad(0.0955343171954155f, _1521, mad(0.8596711158752441f, _1520, (_1519 * 0.044794563204050064f))) - _1437) * cb0_012w) + _1437;
          float _1539 = ((mad(1.0015007257461548f, _1521, mad(0.004025210160762072f, _1520, (_1519 * -0.005525882821530104f))) - _1440) * cb0_012w) + _1440;
                  ...
                  do {
                    ...
                    do {
                      ...
                      do {
                        ...
                        float _1961 = (exp2(_1796 * 3.321928024291992f) - cb0_008y) / _1960;
        ...
        if ((cb0_040w & -3) == 4) {
          float _2115 = cb0_012z * _1228;
          float _2116 = cb0_012z * _1229;
          float _2117 = cb0_012z * _1230;
          ...
          do {
            ...
            float _2223 = ((mad(0.16386906802654266f, _2207, mad(0.14067870378494263f, _2206, (_2205 * 0.6954522132873535f))) - _2120) * cb0_012w) + _2120;
            float _2224 = ((mad(0.0955343171954155f, _2207, mad(0.8596711158752441f, _2206, (_2205 * 0.044794563204050064f))) - _2123) * cb0_012w) + _2123;
            float _2225 = ((mad(1.0015007257461548f, _2207, mad(0.004025210160762072f, _2206, (_2205 * -0.005525882821530104f))) - _2126) * cb0_012w) + _2126;
                    ...
                    do {
                      ...
                      do {
                        ...
                        do {
                          ...
                          float _2658 = cb0_008w - cb0_008y;
                          float _2659 = (exp2(_2482 * 3.321928024291992f) - cb0_008y) / _2658;
                          float _2661 = (exp2(_2568 * 3.321928024291992f) - cb0_008y) / _2658;
                          float _2663 = (exp2(_2654 * 3.321928024291992f) - cb0_008y) / _2658;
                          ...
                          float _2718 = min(max((min(max(mad(-0.23642469942569733f, _2696, mad(-0.32480329275131226f, _2693, (_2690 * 1.6410233974456787f))), 0.0f), 65535.0f) * cb0_008w), 0.0f), 65535.0f);
                          float _2719 = min(max((min(max(mad(0.016756348311901093f, _2696, mad(1.6153316497802734f, _2693, (_2690 * -0.663662850856781f))), 0.0f), 65535.0f) * cb0_008w), 0.0f), 65535.0f);
                          float _2720 = min(max((min(max(mad(0.9883948564529419f, _2696, mad(-0.008284442126750946f, _2693, (_2690 * 0.011721894145011902f))), 0.0f), 65535.0f) * cb0_008w), 0.0f), 65535.0f);
                          do {
                            if (!(cb0_040w == 6)) {
